...
reg import "Dependencies\clear.reg"
...
set "langRegFile=Language\en.reg"
set "uiLang="
...
if /I "!uiPrefix!"=="de" (
    set "langRegFile=Language\de.reg"
) else if /I "!uiPrefix!"=="es" (
    set "langRegFile=Language\es.reg"
) else if /I "!uiPrefix!"=="it" (
    set "langRegFile=Language\it.reg"
) else if /I "!uiPrefix!"=="fr" (
    set "langRegFile=Language\fr.reg"
)
