...
script training_4_1_show_title 
	training_show_title \{title = "Didacticiel sur le hammer-on et pull-off"}
	begin
...
script training_4_1_explain 
	training_set_lesson_header_text \{text = "LEÇON 1 : BASES SUR LES CORDES"}
...
script training_4_2_explain 
	training_set_lesson_header_text \{text = "LEÇON 2 : DOIGTÉ HAMMER-ON"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
endscript
...
script training_4_2_zoom_guitar 
	training_set_lesson_header_body \{text = "1. Joue la frette verte normalement (avec médiator)\\n2. Joue la rouge (sans médiator)\\n3. Joue la jaune (sans médiator)"}
	training_show_lesson_header
	training_set_task_header_body \{text = "Réussis 3 séquences hammer-on pour continuer"}
...
script training_4_3_start_gem_scroller 
	destroy_band
	training_set_lesson_header_text \{text = "LEÇON 3 : HAMMER-ON"}
	training_set_lesson_header_body \{text = "1.  Entraîne-toi au hammer-on."}
	training_show_lesson_header
	safe_show \{id = god_icon}
...
script training_4_3_explain 
	...
	training_play_sound \{Sound = 'Tutorial_4c_01_God'
		Wait}
	training_set_task_header_body \{text = "Joue 8 note avec le hammer-on."}
	training_show_task_header
...
script training_4_4_explain 
	training_set_lesson_header_text \{text = "LEÇON 4 : DOIGTÉ PULL-OFF"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
...
script training_4_4_zoom_guitar 
	training_set_lesson_header_body \{text = "1. Joue la frette jaune normalement (avec médiator)\\n2. Relâche la rouge (sans médiator)\\n3. Relâche la verte (sans médiator)"}
	training_show_lesson_header
	training_set_task_header_body \{text = "Réussis 3 séquences pull-off pour continuer."}
	training_show_task_header
	hide_strum_fingers
	hide_fret_fingers
	if ScreenElementExists \{id = guitar_sprite}
...
script training_4_5_start_gem_scroller 
	destroy_band
	training_set_lesson_header_text \{text = "LEÇON 5 : PULL-OFF"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
	safe_show \{id = lou_icon}
...
script training_4_5_explain 
	Wait \{1
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_body \{text = "1. Entraîne-toi au pull-off"}
	training_show_lesson_header
	training_set_task_header_body \{text = "Joue 8 notes en pull-off pour continuer."}
	training_show_task_header
	training_display_notes_hit \{notes_hit = 0}
...
script training_4_5_complete_message 
	...
	CreateScreenElement {
		...
		pos = (640.0, 350.0)
		font = ($training_font)
		text = "Didacticiel des techniques avancées terminé !"
		scale = 1.0
		rgba = ($training_text_color)
	}
