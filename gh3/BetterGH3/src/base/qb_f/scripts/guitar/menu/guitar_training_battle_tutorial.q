...
script training_3_show_title 
	training_show_title \{title = "Didacticiel sur les duels Guitar Hero"}
	begin
...
script training_3_1_show_lesson 
	...
	training_set_lesson_header_text \{text = "LEÇON 1 : OBTENIR DES ATTAQUES"}
	training_set_lesson_header_body \{text = "1. Réussis une séquence Battle Power pour recevoir une attaque."}
	training_show_lesson_header
	safe_show \{id = god_icon}
	training_play_sound \{Sound = 'Tutorial_3A_01_God'
		Wait}
	training_set_task_header_body \{text = "Réussis une série d'étoiles pour continuer"}
...
script training_3_2_show_lesson 
	...
	change \{structurename = player1_status
		star_power_usable = 0}
	training_set_lesson_header_text \{text = "LEÇON 2 : UTILISER LES ATTAQUES"}
	...
	training_set_task_header_body \{text = "Lève le manche pour lancer une attaque."}
	training_show_task_header
	Wait \{2
		seconds
		ignoreslomo}
...
script training_3_3_show_lesson 
	...
	Wait \{1.0
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_text \{text = "LEÇON 3 : DIFFÉRENTES ATTAQUES"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
	training_hide_task_header
	safe_show \{id = god_icon}
	training_play_sound \{Sound = 'Tutorial_3C_01_God'
		Wait}
	training_set_task_header_body \{text = "Appuie rapidement sur la frette de la corde cassée."}
	training_show_task_header
	Wait \{1
		seconds
		ignoreslomo}
...
script training_3_4_show_lesson 
	Wait \{1
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_text \{text = "LEÇON 4 : ATTAQUES MULTIPLES"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
	training_hide_task_header
	safe_show \{id = lou_icon}
	...
	training_play_sound \{Sound = 'Tutorial_3D_01_Lou'
		Wait}
	training_set_task_header_body \{text = "Utilise les 2 attaques sur ton adversaire"}
	training_show_task_header
	change \{structurename = player1_status
		current_num_powerups = 0}
	bossbattle_ready \{battle_gem = 0
...
script training_3_4_show_complete_message 
	...
	CreateScreenElement {
		...
		pos = (640.0, 350.0)
		font = ($training_font)
		text = "Didacticiel sur le duel de guitare terminé"
		scale = 1.0
		rgba = ($training_text_color)
	}
	Wait \{0.5
