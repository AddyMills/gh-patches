...
script training_4_1_show_title 
	training_show_title \{title = "해머 온과 풀 오프 훈련"}
	begin
...
script training_4_1_explain 
	training_set_lesson_header_text \{text = "강좌 1: 기타 줄 기본"}
...
script training_4_2_explain 
	training_set_lesson_header_text \{text = "강좌 2: 해머 온 핑거링"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
endscript
...
script training_4_2_zoom_guitar 
	training_set_lesson_header_body \{text = "1. 녹색을 일반적으로 연주(스트럼)\\n2. 빨간색 해머 온(스트럼 없이)\\n3. 노란색 해머 온(스트럼 없이)"}
	training_show_lesson_header
	training_set_task_header_body \{text = "계속하려면 3개의 해머 온 시퀀스 연주"}
...
script training_4_3_start_gem_scroller 
	destroy_band
	training_set_lesson_header_text \{text = "강좌 3: 해머 온"}
	training_set_lesson_header_body \{text = "1. 해머 온 연습"}
	training_show_lesson_header
	safe_show \{id = god_icon}
...
script training_4_3_explain 
	...
	training_play_sound \{Sound = 'Tutorial_4c_01_God'
		Wait}
	training_set_task_header_body \{text = "해머 온 기술을 사용해 8개의 노트를 연주"}
	training_show_task_header
...
script training_4_4_explain 
	training_set_lesson_header_text \{text = "강좌 4: 풀 오프 핑거링"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
...
script training_4_4_zoom_guitar 
	training_set_lesson_header_body \{text = "1. 노란색을 일반적으로 연주(스트럼)\\n2. 빨간색 풀 오프(스트럼 없이)\\n3. 녹색 풀 오프(스트럼 없이)"}
	training_show_lesson_header
	training_set_task_header_body \{text = "계속하려면 3개의 풀 오프 시퀀스 연주"}
	training_show_task_header
	hide_strum_fingers
	hide_fret_fingers
	if ScreenElementExists \{id = guitar_sprite}
...
script training_4_5_start_gem_scroller 
	destroy_band
	training_set_lesson_header_text \{text = "강좌 5: 풀 오프"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
	safe_show \{id = lou_icon}
...
script training_4_5_explain 
	Wait \{1
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_body \{text = "1. 풀 오프 연습"}
	training_show_lesson_header
	training_set_task_header_body \{text = "계속하려면 풀 오프를 사용해 8개의 노트를 연주"}
	training_show_task_header
	training_display_notes_hit \{notes_hit = 0}
