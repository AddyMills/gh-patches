...
script training_basic_tutorial_show_title 
	training_show_title \{title = "Guitar Hero 기본 훈련"}
	begin
...
script training_1_1_show_lesson_header 
	training_set_lesson_header_text \{text = "강좌 1: 기타 튜닝"}
	training_set_lesson_header_body \{text = "1. 프렛 단추를 누르고 노트 선택\\n2. 스트럼 막대를 위나 아래로 눌러서 노트 연주"}
	training_set_task_header_body \{text = "계속하려면 각 노트를 3번씩 연주"}
...
script training_1_2_start_gem_scroller 
	...
	training_set_lesson_header_text \{text = "강좌 2: 노트 연주"}
	training_set_lesson_header_body \{text = "1. 노트가 선과 겹치면 기타로 연주"}
	training_show_lesson_header
	safe_show \{id = god_icon}
endscript
...
script training_1_2_show_lesson 
	...
	Wait \{6
		seconds
		ignoreslomo}
	training_set_task_header_body \{text = "계속하려면 8개의 노트 연주"}
	training_show_task_header
...
script training_1_3_show_lesson 
	Wait \{1
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_text \{text = "강좌 3: 다른 노트"}
	training_set_lesson_header_body \{text = "1. 다른 노트를 연주하려면 노트 색깔을 맞춤"}
	training_show_lesson_header
	safe_show \{id = god_icon}
	training_play_sound \{Sound = 'Tutorial_1C_01_God'
		Wait}
	training_set_task_header_body \{text = "계속하려면 서로 다른 노트를 8개 연주"}
	training_show_task_header
	Wait \{2
		seconds
		ignoreslomo}
...
script training_1_4_start_gem_scroller 
	...
	training_set_lesson_header_text \{text = "강좌 4: 긴 노트"}
...
script training_1_4_show_lesson 
	Wait \{3.55
		...
		ignoreslowmo}
	training_pause_gem_scroller
	training_set_lesson_header_body \{text = "1. 프렛 단추를 누름\\n2. 스트럼\\n3. 노트 전체를 연주할 때까지 프렛을 누르고 있어야 함"}
	training_show_lesson_header
	...
	training_wait_for_sound \{Sound = 'Tutorial_1D_01_God'
		Wait}
	training_set_task_header_body \{text = "계속하려면 8개의 긴 노트 연주"}
	training_show_task_header
	training_display_notes_hit \{notes_hit = 0}
	Wait \{2
		seconds
...
script training_1_5_start_gem_scroller 
	...
	training_set_lesson_header_text \{text = "강좌 5: 화음"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
...
script training_1_5_show_lesson 
	Wait \{3.5
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_body \{text = "두 개의 노트가 동시에 연주됨"}
	training_show_lesson_header
	...
	training_set_task_header_body \{text = "계속하려면 8개의 화음 연주"}
	training_show_task_header
	training_display_notes_hit \{notes_hit = 0}
	Wait \{2
		seconds
...
script training_1_6_show_hud 
	training_set_lesson_header_text \{text = "강좌 6: 사용자 인터페이스"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
	safe_show \{id = god_icon}
	...
	Wait \{8.0
		seconds
		ignoreslomo}
	training_set_lesson_header_body \{text = "노란색 = 괜찮은 연주"}
	Wait \{5.5
		seconds
		ignoreslomo}
