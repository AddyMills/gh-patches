...
script check_for_any_input \{button1 = {
	...
	if NOT iswinport
		if IsStandardGuitarControllerPluggedIn
			if english
				notify_box scale1 = (0.6, 0.75) scale2 = (0.5, 0.6) container_pos = (0.0, 350.0) container_id = notify_invalid_device line1 = "지원되지 않는 기타 컨트롤러가 감지되었습니다." line2 = "계속하려면 Guitar Hero 기타나" line3 = "Xbox 360 컨트롤러를 연결하신 후 START 단추를 누르십시오." menu_z = 510000 FormatText textname = pakname '%s_text.pak' s = <stem>
			elseif french
