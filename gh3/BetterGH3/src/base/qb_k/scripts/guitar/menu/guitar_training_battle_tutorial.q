...
script training_3_show_title 
	training_show_title \{title = "Guitar Hero 배틀 훈련"}
	begin
...
script training_3_1_show_lesson 
	...
	training_set_lesson_header_text \{text = "강좌 1: 파워업 획득"}
	training_set_lesson_header_body \{text = "1. 배틀 파워 시퀀스를 완료해 기타 배틀 파워업 얻기"}
	training_show_lesson_header
	safe_show \{id = god_icon}
	training_play_sound \{Sound = 'Tutorial_3A_01_God'
		Wait}
	training_set_task_header_body \{text = "계속하려면 스타 시퀀스 연주"}
...
script training_3_2_show_lesson 
	...
	change \{structurename = player1_status
		star_power_usable = 0}
	training_set_lesson_header_text \{text = "강좌 2: 파워업 사용"}
	...
	training_set_task_header_body \{text = "어택을 사용하려면 기타를 위로 기울임"}
	training_show_task_header
	Wait \{2
		seconds
		ignoreslomo}
...
script training_3_3_show_lesson 
	...
	Wait \{1.0
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_text \{text = "강좌 3: 다른 어택"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
	training_hide_task_header
	safe_show \{id = god_icon}
	training_play_sound \{Sound = 'Tutorial_3C_01_God'
		Wait}
	training_set_task_header_body \{text = "끊어진 줄의 단추를 빠르게 누름"}
	training_show_task_header
	Wait \{1
		seconds
		ignoreslomo}
...
script training_3_4_show_lesson 
	Wait \{1
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_text \{text = "강좌 4: 다중 어택"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
	training_hide_task_header
	safe_show \{id = lou_icon}
	...
	training_play_sound \{Sound = 'Tutorial_3D_01_Lou'
		Wait}
	training_set_task_header_body \{text = "상대방에게 피해를 입히려면 두 가지 어택을 모두 사용"}
	training_show_task_header
	change \{structurename = player1_status
		current_num_powerups = 0}
	bossbattle_ready \{battle_gem = 0
