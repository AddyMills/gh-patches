save_changes_message = "플레이어 옵션을 종료하려고 합니다. 계속하면 모든 변경 사항은 적용되지 않습니다. 먼저 변경 사항을 저장하시겠습니까?"

script create_online_options_menu \{menu_title = "옵션"
		menu_subtitle = "온라인 옵션"
