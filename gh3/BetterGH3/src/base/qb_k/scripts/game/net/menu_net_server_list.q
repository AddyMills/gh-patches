...
script create_online_server_list 
	...
	add_user_control_helper \{text = "뒤로"
		button = red
		z = 100}
	add_user_control_helper \{text = "새로 고침"
		button = blue
		z = 100}
...
script create_server_list_searching_dialog \{menu_id = server_list_searching_dialog_menu
	...
	add_searching_menu_item vmenu_id = <vmenu_id> choose_script = searching_dialog_select_stop text = "중지"
	add_searching_menu_item vmenu_id = <vmenu_id> choose_script = searching_dialog_select_cancel text = "취소"
	set_focus_color rgba = ($online_dark_purple)
	set_unfocus_color rgba = (online_light_blue)
...
script create_server_list_create_match_dialog \{menu_id = server_list_create_match_dialog_menu
	...
	add_searching_menu_item vmenu_id = <vmenu_id> choose_script = create_match_dialog_select_create text = "매치 생성"
	add_searching_menu_item vmenu_id = <vmenu_id> choose_script = create_match_dialog_select_cancel text = "취소"
