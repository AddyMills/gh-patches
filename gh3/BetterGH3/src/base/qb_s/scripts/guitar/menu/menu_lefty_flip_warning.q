...
script create_lefty_flip_warning_menu 
	...
	create_popup_warning_menu {
		textblock = {
			text = "Para modificar la config. para zurdos debes reiniciar este tema. Si lo haces, se perderá todo el progreso que no haya sido guardado. ¿Seguro que quieres continuar? "
			dims = (800.0, 400.0)
			scale = 0.55
		}
