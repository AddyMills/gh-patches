...
script training_4_1_show_title 
	training_show_title \{title = "Tutorial sobre hammer-ons y pull-offs"}
	begin
...
script training_4_1_explain 
	training_set_lesson_header_text \{text = "LECCIÓN 1: NOCIONES SOBRE LAS CUERDAS"}
...
script training_4_2_explain 
	training_set_lesson_header_text \{text = "LECCIÓN 2: DIGITACIÓN Y HAMMER-ON"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
endscript
...
script training_4_2_zoom_guitar 
	training_set_lesson_header_body \{text = "1. Toca el botón verde (rasguea).\\n2. Pulsa el botón rojo (no rasguees).\\n3. Pulsa el botón amarillo (no rasguees)."}
	training_show_lesson_header
	training_set_task_header_body \{text = "Toca 3 secuencias de hammer-ons para seguir."}
...
script training_4_3_start_gem_scroller 
	destroy_band
	training_set_lesson_header_text \{text = "LECCIÓN 3: HAMMER-ONS"}
	training_set_lesson_header_body \{text = "1.  Practica los hammer-ons"}
	training_show_lesson_header
	safe_show \{id = god_icon}
...
script training_4_3_explain 
	...
	training_play_sound \{Sound = 'Tutorial_4c_01_God'
		Wait}
	training_set_task_header_body \{text = "Toca 8 notas con la técnica de hammer-ons."}
	training_show_task_header
...
script training_4_4_explain 
	training_set_lesson_header_text \{text = "LECCIÓN 4: DIGITACIÓN Y PULL-OFF "}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
...
script training_4_4_zoom_guitar 
	training_set_lesson_header_body \{text = "1. Toca el botón amarillo (rasguea).\\n2. Suelta el botón rojo (no rasguees).\\n3. Suelta el botón verde (no rasguees)."}
	training_show_lesson_header
	training_set_task_header_body \{text = "Acierta la secuencia de tres pull-offs para continuar."}
	training_show_task_header
	hide_strum_fingers
	hide_fret_fingers
	if ScreenElementExists \{id = guitar_sprite}
...
script training_4_5_start_gem_scroller 
	destroy_band
	training_set_lesson_header_text \{text = "LECCIÓN 5: PULL-OFFS"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
	safe_show \{id = lou_icon}
...
script training_4_5_explain 
	Wait \{1
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_body \{text = "1. Practica los pull-offs"}
	training_show_lesson_header
	training_set_task_header_body \{text = "Acierta 8 notas utilizando la técnica de pull-offs para continuar."}
	training_show_task_header
	training_display_notes_hit \{notes_hit = 0}
...
script training_4_5_complete_message 
	...
	CreateScreenElement {
		...
		pos = (640.0, 350.0)
		font = ($training_font)
		text = "¡Tutorial sobre técnicas avanzadas completado!"
		scale = 1.0
		rgba = ($training_text_color)
	}
