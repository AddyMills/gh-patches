...
script training_2_1_show_title 
	training_show_title \{title = "Tutorial sobre la energía Estrella"}
	begin
...
script training_2_1_start_gem_scroller 
	...
	training_set_lesson_header_text \{text = "LECCIÓN 1: COMBOS ESTRELLA"}
	training_set_lesson_header_body \{text = "Clava las notas de un Combo Estrella y obtén un Subidón Estrella."}
...
script training_2_1_explain 
	...
	training_wait_for_sound \{Sound = 'Tutorial_2A_01_lou'
		Wait}
	training_set_task_header_body \{text = "Para seguir, clava el Combo Estrella."}
...
script training_2_2_show_whammy 
	Wait \{1
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_text \{text = "LECCIÓN 2: BARRA DE VIBRATO"}
	...
	training_set_lesson_header_body \{text = "Toca una nota y empuja la barra de vibrato dentro y fuera para acumular energía Estrella."}
	training_show_lesson_header
	training_set_task_header_body \{text = "Para seguir, haz que suba el medidor Estrella."}
	training_show_task_header
...
script training_2_3_start_gem_scroller 
	...
	training_set_lesson_header_text \{text = "LECCIÓN 3: LIBERAR ENERGÍA ESTRELLA"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
	safe_show \{id = lou_icon}
	change \{training_received_star_power = 0}
...
script training_2_3_explain 
	...
	training_set_lesson_header_body \{text = "Levanta la guitarra para activar la energía Estrella.\\nCuando la has liberado, ya puedes volver a bajar la guitarra."}
	training_show_lesson_header
	training_set_task_header_body \{text = "Para seguir, levanta la guitarra, acumula energía Estrella y toca 8 notas."}
	training_show_task_header
...
script training_2_tutorial_complete_message 
	...
	CreateScreenElement {
		...
		pos = (640.0, 350.0)
		font = ($training_font)
		text = "¡Tutorial sobre la energía Estrella completado!"
		scale = 1.0
		rgba = ($training_text_color)
	}
