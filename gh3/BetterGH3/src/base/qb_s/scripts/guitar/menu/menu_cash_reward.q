cash_deduction_types = [
	{
		desc = "COCHES INCENDIADOS"
		val = 2500
	}
	{
		desc = "OBRA DE ARTE MANGADA"
		val = 80
	}
	{
		desc = "CAMERINO DESTROZADO"
		val = 210
	}
	{
		desc = "CONTAMINACIÓN ACÚSTICA"
		val = 550
	}
	{
		desc = "SUITE HECHA TRIZAS"
		val = 330
	}
	{
		desc = "ALCOHOL CONSUMIDO"
		val = 300
	}
]
review_string_3star = "Crítica mediocre de 3 estrellas. Esta es tu parte."
review_string_4star = "Crítica genial de 4 estrellas. Esta tu parte."
review_string_5star = "Crítica bestial de 5 estrellas. Esta es tu parte."
...
script create_cash_reward_menu 
	...
	CreateScreenElement {
		...
		scale = 0.7
		pos = (355.0, 140.0)
		text = "Ve a comprarte algo chulo."
		font = ($cash_reward_font)
		rgba = [0 0 0 255]
		just = [left top]
		z_priority = 3
