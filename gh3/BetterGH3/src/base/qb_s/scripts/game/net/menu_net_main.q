info_text = [
	...
	"Atrévete con una partida igualada y dale caña al primer rockero que se cruce en tu camino."
	...
	"¡Descargas disponibles próximamente!"
...
script create_online_main_menu \{menu_title_xenon = "Menú en línea"
		menu_title_ps3 = "Menú en línea"
	...
	net_add_item_to_main_menu {
		VMenu = <vmenu_id>
		text = "Opciones de partida rápida"
		info_text_index = 5
...
script create_link_text 
	...
	CreateScreenElement {
		...
		scale = (0.75, 0.75)
		rgba = ($online_light_blue)
		text = "¿Quieres convertirte en un Guitar Hero? Consulta\\n tus estadísticas en la Web:"
		just = [center top]
		internal_just = [center top]
		z_priority = 6.0
		pos = (640.0, 160.0)
...
script net_add_item_to_main_menu \{line_spacing = 40}
	...
	if (<text> = "Partida rápida: Partida igualada")
