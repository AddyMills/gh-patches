...
battle_explanation_text = {
	bossslash = {
		...
		title = "SLASH WILL KÄMPFEN!"
		bullets = [
			{
				text = "Anstelle von Starpower bekommst du BATTLEPOWER"
			}
			{
				text = "Triff die BATTLESYMBOLE und erhalte ein POWER-UP"
			}
			{
				text = "Zieh deine Gitarre hoch, um Slash anzugreifen und einen Fehlschlag zu provozieren"
			}
			{
				text = "Du MUSST dafür sorgen, dass er vor dem Ende des Songs VERSAGT, sonst VERLIERST DU."
			}
			{
				text = "Sei vorsichtig, er kann sich wehren"
			}
		]
		prompt = "Bist du bereit zu rocken?"
	}
	bosstom = {
		image = battle_help_boss_bg_morello
		title = "MORELLO FORDERT DICH HERAUS!"
		bullets = [
			{
				text = "Anstelle von Starpower bekommst du BATTLEPOWER"
			}
			...
			{
				text = "Zieh deine Gitarre hoch, um Tom anzugreifen und einen Fehlschlag zu provozieren"
			}
			{
				text = "Du MUSST dafür sorgen, dass er vor dem Ende des Songs VERSAGT, sonst VERLIERST DU."
			}
	...
	bossdevil = {
		...
		bullets = [
			...
			{
				text = "Zieh deine Gitarre hoch, um Lou anzugreifen und einen Fehlschlag zu provozieren"
			}
			{
				text = "Du MUSST dafür sorgen, dass er vor dem Ende des Songs VERSAGT, sonst VERLIERST DU."
			}
	...
	generic = {
		...
		bullets = [
			...
			{
				text = "Zieh deine Gitarre hoch, um einen Fehlschlag zu provozieren"
			}
			{
				text = "Erreichen beide Spieler das SONGENDE, kommt es zum SUDDEN DEATH"
			}
			{
				text = "Im SUDDEN DEATH wirken alle Power-Ups sofort TÖDLICH"
			}
		]
		prompt = "Bist du bereit zu rocken?"
	}
...
script create_battle_helper_menu \{device_num = 0
	...
	add_user_control_helper \{text = "SCHLACHT"
		button = green
		z = 100}
	add_user_control_helper \{text = "VERWERFEN"
		button = red
		z = 100}
endscript
