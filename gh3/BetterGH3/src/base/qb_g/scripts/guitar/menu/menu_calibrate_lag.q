...
script create_calibrate_lag_menu \{from_in_game = 1}
	...
	displayText \{parent = cl_container
		...
		noshadow}
	upper_helper = "Bei einigen HDTV-Geräten kommt es zu Verzögerungen zwischen Ton und Bild, die das Spielen erschweren."
	lower_helper = "Schlag deine Gitarre im Takt der über das Ziel laufenden Noten an."
	CreateScreenElement {
