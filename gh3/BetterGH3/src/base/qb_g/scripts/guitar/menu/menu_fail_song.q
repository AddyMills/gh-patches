...
script create_fail_song_menu 
	...
	if ($is_boss_song = 1)
		title = "SCHLACHT VERLOREN"
	else
		title = "SONG MISSLUNGEN"
	endif
	CreateScreenElement {
		type = TextElement
	...
	if ($current_song = bosstom || $current_song = bossslash || $current_song = bossdevil)
		...
		CreateScreenElement <completion_text_params> scale = 2 text = "GEWINNT" rgba = [223 223 223 255]
		CreateScreenElement <completion_text_params> scale = 1 text = " "
		CreateScreenElement <completion_text_params> scale = 1 text = "IN"
		CreateScreenElement <completion_text_params> scale = 1 text = " "
...
script fill_song_title_and_completion_details 
	...
	CreateScreenElement <completion_text_params> scale = 1 text = "GESCHAFFT:"
	CreateScreenElement <completion_text_params> scale = 1 text = " "
