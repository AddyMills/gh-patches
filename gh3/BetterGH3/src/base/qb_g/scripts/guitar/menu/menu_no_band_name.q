...
no_band_name_messages = [
	"Wenn du nicht 'The Artist formerly known as Prince' bist, dann gib einen Namen ein."
	"GIB EINEN @+$#&% NAMEN EIN!!!"
	"Denkst du, du wärst besser als andere? Gib einen Namen ein."
	"Jedes Mal, wenn du keinen Bandnamen eingibst, muss ein Kätzchen sterben."
	"Warum gibst du keinen Bandnamen ein? Das macht richtig Spaß."
	"Was sollen deine Fans denn rufen, wenn du keinen Namen hast?"
	"Hier ist ein Vorschlag für einen Bandnamen: Lazy McUnimaginative"
	"Komm schon!"
]
