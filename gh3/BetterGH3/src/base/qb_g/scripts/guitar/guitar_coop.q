GH3_CoopCareer_Songs = {
	...
	tier1 = {
		title = "1. Stell eine Band zusammen"
		songs = [
			barracuda
			whenyouwereyoung
			bullsonparade
	...
	tier2 = {
		title = "2. Wir wollen bloß berühmt werden."
		songs = [
			schoolsout
			koolthing
			missmurder
	...
	tier4 = {
		title = "4. Bring die Band wieder zusammen"
		songs = [
			holidayincambodia
			blackmagicwoman
			sameoldsonganddance
