...
battlemode_powerups = [
	{
		name = lightning
		name_text = "Verstärker überlastet"
		weight = 10
		weight_low = 0
		weight_losing = 0
	...
	{
		name = DifficultyUp
		name_text = "Höhere Schwierigkeitsstufe"
		weight = 10
		weight_low = 0
		weight_losing = 0
	...
	{
		name = LeftyNotes
		name_text = "Linkshänderoption"
		alt_name_text = "Rechtshänderoption"
		weight = 10
		weight_low = 0
		weight_losing = 10
	...
	{
		name = DeathLick
		name_text = "tödlicher Kraftentzug"
		weight = 0
		weight_low = 0
		weight_losing = 0
