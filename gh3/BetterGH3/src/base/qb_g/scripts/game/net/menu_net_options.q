save_changes_message = "Sie sind dabei, die Spieleroptionen zu beenden. Wenn Sie fortfahren, werden vorgenommene Änderungen nicht gespeichert. Wollen Sie Ihre Änderungen erst SPEICHERN?"

script create_online_options_menu \{menu_title = "OPTIONEN"
		menu_subtitle = "ONLINEOPTIONEN"
