save_changes_message = "Stai per uscire dalle Opzioni giocatore. Se decidi di continuare, le modifiche effettuate non verranno salvate. Vuoi SALVARE le modifiche prima?"

script create_online_options_menu \{menu_title = "OPZIONI"
		menu_subtitle = "OPZIONI ONLINE"
