...
sponsor_info = {
	tier1 = {
		...
		sponsorship_desc = "Quelli di Audio Technica sono rimasti colpiti dal concerto! È ora di passare al livello successivo! Ti concedono un contratto di sponsorizzazione e i loro leggendari microfoni."
		sponsorship_value = 1440
	}
	tier2 = {
		logo_texture = Sponsor_Logo_Line6
		product_texture = sponsor_photo_line6
		sponsorship_desc = "Quelli di Line 6 ritengono che tu abbia davvero sfondato all'ultimo concerto, quindi è ora di alzare il tiro! Ti concedono un contratto di sponsorizzazione e le loro fantastiche attrezzature per consentirti di darci dentro come si deve."
		sponsorship_value = 1440
	}
	tier3 = {
		logo_texture = Sponsor_Logo_ErnieBall
		product_texture = sponsor_photo_ernieBall
		sponsorship_desc = "Quelli di Ernie Ball pensano che hai talento da vendere e vogliono aiutarti a sfondare! Ti stanno proponendo un contratto di sponsorizzazione e potrai sfasciare tutte le corde che vorrai, quindi dacci dentro!"
		sponsorship_value = 1440
	}
	tier4 = {
		logo_texture = Sponsor_Logo_Mackie
		product_texture = sponsor_photo_mackie
		sponsorship_desc = "Quelli di Mackie pensano che tu sia il massimo. Cerca di restare con i piedi per terra! Ti concedono una sponsorizzazione con delle casse spie fantasmagoriche, così puoi sentire quello che suoni invece della batteria."
		sponsorship_value = 1440
	}
	tier5 = {
		logo_texture = Sponsor_Logo_Zildjian
		product_texture = sponsor_photo_zildjian
		sponsorship_desc = "Alla Zildjian pensano che raggiungerai la vetta, quindi... vedi di darci dentro come si deve! Ti propongono una sponsorizzazione e ti offrono la loro linea di piatti. Fai vedere quello che sai fare!"
		sponsorship_value = 1440
	}
	tier6 = {
		logo_texture = Sponsor_Logo_Crate
		product_texture = sponsor_photo_crate
		sponsorship_desc = "Quelli di Crate Amps sono convinti che tu abbia talento. È il momento giusto per far vedere di che pasta sei fatto! I timpani ne risentiranno un po', ma non il tuo portafogli: ti sponsorizzeranno fornendoti tutti gli amplificatori di cui avrai bisogno!"
		sponsorship_value = 1440
	}
	tier7 = {
		logo_texture = Sponsor_Logo_Krank
		product_texture = sponsor_photo_krank
		sponsorship_desc = "Quelli di Krank Amplification hanno trovato i tuoi assolo fulminanti! Dicono che se suonerai una volta provate le loro apparecchiature, non potrai più farne a meno. Per fortuna te li forniscono gratis!"
		be
		sponsorship_value = 1440
	}
}
