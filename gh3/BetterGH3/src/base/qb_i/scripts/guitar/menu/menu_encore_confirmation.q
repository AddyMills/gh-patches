...
script create_encore_confirmation_menu 
	...
	if (<song_struct>.checksum = bosstom)
		bossText = "SUONA UN BIS CON TOM MORELLO!"
		bossdims = (800.0, 0.0)
	elseif (<song_struct>.checksum = bossslash)
		bossText = "SUONA UN BIS CON SLASH!"
		bossdims = (800.0, 0.0)
	endif
	...
	displayText id = ec_crowd_text_1 parent = ec_crowd_1 text = "evvai!" pos = (60.0, 35.0) rgba = [0 0 0 255] z = (<menu_z> + 51) just = [center center] scale = 0.8 noshadow
	displayText id = ec_crowd_text_2 parent = ec_crowd_2 text = "evvai!" pos = (60.0, 35.0) rgba = [0 0 0 255] z = (<menu_z> + 51) just = [center center] scale = 0.8 noshadow
	displayText id = ec_crowd_text_3 parent = ec_crowd_3 text = "evvai!" pos = (60.0, 35.0) rgba = [0 0 0 255] z = (<menu_z> + 51) just = [center center] scale = 0.8 noshadow
	displayText id = ec_crowd_text_4 parent = ec_crowd_4 text = "evvai!" pos = (60.0, 35.0) rgba = [0 0 0 255] z = (<menu_z> + 51) just = [center center] scale = 0.8 noshadow
	...
	LaunchEvent \{type = focus
		target = ec_vmenu}
	add_user_control_helper text = " SELEZIONA" button = green z = (<menu_z> + 100)
	add_user_control_helper text = "SU/GIÙ" button = strumbar z = (<menu_z> + 100)
endscript
