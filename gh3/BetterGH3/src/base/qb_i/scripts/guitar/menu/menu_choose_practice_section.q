...
menu_choose_practice_section_start_text = "SELEZIONA PARTE INIZIALE"
menu_choose_practice_section_end_text = "SELEZIONA PARTE FINALE"
...
script menu_choose_practice_section_refresh_entries 
	...
	if ScreenElementExists id = <entry_id>
		if ((<entry> + ($menu_choose_practice_section_base)) = 0)
			SetScreenElementProps id = <entry_id> text = "BRANO COMPLETO"
		else
