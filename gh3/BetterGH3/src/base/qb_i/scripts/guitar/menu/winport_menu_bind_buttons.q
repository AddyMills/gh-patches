...
winport_bb_kb_menuItems = [
	{
		text = "Tasto verde / Conferma"
		handler = winport_bb_choose_control
		actionNum = 0
	}
	{
		text = "Tasto rosso / Annulla"
		handler = winport_bb_choose_control
		actionNum = 1
	}
	{
	...
	{
		text = "Vibrato col mouse"
		controlName = "Asse X"
		handler = winport_null_script
		disable
	}
	{
		text = "Strimpella in su / Menu in su"
		handler = winport_bb_choose_control
		actionNum = 10
	}
	{
		text = "Strimpella in giù / Menu in giù"
		handler = winport_bb_choose_control
		actionNum = 9
	}
	{
	...
	{
		text = "Ripristina tastiera/mouse predefiniti"
		handler = winport_bb_reset_to_config1
	}
	{
		text = "Ripristina impostazioni predefinite tastiera"
