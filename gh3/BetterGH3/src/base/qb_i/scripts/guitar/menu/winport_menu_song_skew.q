...
script winport_create_calibrate_lag_menu \{from_in_game = 1}
	...
	upper_helper = "Puoi impostare il valore tra 0 ms e 200 ms.\\n\\nAlcuni computer possono andare fuori sincronizzazione a causa di alcune componenti hardware. Se sei costretto a suonare le note prima della musica, prova ad aggiungere 20 ms al valore.  Sottrai 20 ms se invece sei costretto a suonare dopo la musica. Puoi regolare il valore anche in base alle tue preferenze personali."
	CreateScreenElement {
...
script winport_menu_calibrate_lag_create_circles 
	...
	add_user_control_helper \{text = "SUONA"
		button = strumbar
		z = 100}
	destroy_menu \{menu_id = winport_cl_scroll}
...
script winport_menu_calibrate_lag_say_lines_are_even 
	...
	output_log_text "Calibra: %o" o = <new_input_diff> color = white
...
script winport_create_audio_calibrate_reminder 
	...
	CreateScreenElement {
		...
		pos = (640.0, 270.0)
		dims = (500.0, 500.0)
		text = "Verifica la calibrazione dell'audio nel menu delle opzioni."
		scale = 0.8
	}
	CreateScreenElement {
		<textProps>
		pos = (640.0, 420.0)
		dims = (650.0, 500.0)
		text = "Per ottimizzare l'esperienza di gioco sul tuo hardware usa lo strumento Calibra latenza nel menu delle opzioni."
		scale = 0.7
	}
