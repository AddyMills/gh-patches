...
script create_calibrate_lag_menu \{from_in_game = 1}
	...
	displayText \{parent = cl_container
		...
		noshadow}
	upper_helper = "Alcuni televisori ad alta definizione hanno un ritardo audio/video che rende difficile poter giocare. Prova la calibratura."
	lower_helper = "Suona la chitarra a tempo con le note che attraversano il bersaglio."
	CreateScreenElement {
