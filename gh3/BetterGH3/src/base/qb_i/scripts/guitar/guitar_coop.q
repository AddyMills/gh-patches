GH3_CoopCareer_Songs = {
	...
	tier2 = {
		title = "2. Vogliamo solo essere famosi"
		songs = [
			schoolsout
			koolthing
			missmurder
	...
	tier4 = {
		title = "4. Il gruppo si ricompone"
		songs = [
			holidayincambodia
			blackmagicwoman
			sameoldsonganddance
	...
	tier6 = {
		title = "6. Combatti per la tua anima"
		songs = [
			knightsofcydonia
			ONE
			numberofthebeast
