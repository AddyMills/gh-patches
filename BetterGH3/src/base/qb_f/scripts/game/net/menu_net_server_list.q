...
script create_online_server_list 
	...
	if (($ui_flow_manager_state [0]) = online_server_list_fs)
		<title_text> = "PARCOURIR PARTIES"
	elseif (($ui_flow_manager_state [0]) = private_match_search_fs)
		<title_text> = "PARTIE PRIVÉE"
	else
		<title_text> = "PARTIE RAPIDE"
	endif
	CreateScreenElement {
		type = TextElement
		parent = search_results_container
	...
	add_user_control_helper \{text = "RETOUR"
		button = red
		z = 100}
	add_user_control_helper \{text = "RAFRAICHIR"
		button = Blue
		z = 100}
...
script create_server_list_searching_dialog \{menu_id = server_list_searching_dialog_menu
	...
	add_searching_menu_item vmenu_id = <vmenu_id> choose_script = searching_dialog_select_stop text = "ARRÊTER"
	add_searching_menu_item vmenu_id = <vmenu_id> choose_script = searching_dialog_select_cancel text = "ANNULER"
	set_focus_color rgba = ($online_dark_purple)
	set_unfocus_color rgba = (online_light_blue)
...
script create_server_list_create_match_dialog \{menu_id = server_list_create_match_dialog_menu
	...
	add_searching_menu_item vmenu_id = <vmenu_id> choose_script = create_match_dialog_select_create text = "CRÉER PARTIE"
	add_searching_menu_item vmenu_id = <vmenu_id> choose_script = create_match_dialog_select_cancel text = "ANNULER"
