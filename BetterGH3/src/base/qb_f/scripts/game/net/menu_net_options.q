save_changes_message = "Tu vas quitter le menu Options joueur. Aucune modification ne sera sauvegardée. Veux-tu d'abord SAUVEGARDER tes modifications ?"

script create_online_options_menu \{menu_title = "OPTIONS"
		menu_subtitle = "OPTIONS EN LIGNE"
