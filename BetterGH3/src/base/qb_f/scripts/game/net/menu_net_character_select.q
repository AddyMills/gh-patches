...
script create_leaving_lobby_dialog \{menu_id = leaving_lobby_dialog_menu
	...
	CreateScreenElement {
		...
		text = "Tu es sur le point de quitter la partie. Es-tu sûr de vouloir quitter la partie ?"
		just = [center top]
		internal_just = [center top]
		z_priority = (<z> + 5)
		pos = (640.0, 310.0)
	...
	if (($ui_flow_manager_state [0]) = online_pause_fs)
		...
		add_user_control_helper text = "CHOISIR" button = green z = (<z> - 10)
		add_user_control_helper text = "RETOUR" button = red z = (<z> - 10)
		add_user_control_helper text = "HAUT/BAS" button = strumbar z = (<z> - 10)
	endif
