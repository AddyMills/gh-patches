GH3_CoopCareer_Songs = {
	...
	tier2 = {
		title = "2. On veut juste être célèbres"
		songs = [
			schoolsout
			koolthing
			missmurder
	...
	tier6 = {
		title = "6. Pour la rédemption de vos âmes"
		songs = [
			knightsofcydonia
			ONE
			numberofthebeast
