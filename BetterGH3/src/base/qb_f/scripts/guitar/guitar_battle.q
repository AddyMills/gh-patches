...
battlemode_powerups = [
	{
		name = lightning
		name_text = "Surcharge de l'ampli"
		weight = 10
		weight_low = 0
		weight_losing = 0
	...
	{
		name = LeftyNotes
		name_text = "Option gaucher"
		alt_name_text = "Option droitier"
		weight = 10
		weight_low = 0
		weight_losing = 10
