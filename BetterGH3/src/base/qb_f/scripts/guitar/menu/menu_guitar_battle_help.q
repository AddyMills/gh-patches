...
battle_explanation_text = {
	bossslash = {
		...
		title = "SLASH VEUT UN DUEL AVEC TOI !"
		bullets = [
			{
				text = "À la place du Star Power, tu as du BATTLE POWER"
			}
			{
				text = "Réussis les BATTLE GEMS pour obtenir une ATTAQUE"
			}
			{
				text = "Lève le manche de ta guitare à la verticale pour attaquer Slash"
			}
			{
				text = "Tu DOIS le DÉCONCENTRER avant la fin sinon TU PERDS"
			}
			{
				text = "Attention, il peut aussi attaquer"
			}
		]
		prompt = "Prêt pour le rock ?"
	}
	bosstom = {
		image = battle_help_boss_bg_morello
		title = "MORELLO TE MET AU DÉFI !"
		bullets = [
			{
				text = "À la place du Star Power, tu as du BATTLE POWER"
			}
			...
			{
				text = "Lève le manche de ta guitare à la verticale pour attaquer Tom"
			}
			{
				text = "Tu DOIS le DÉCONCENTRER avant la fin sinon TU PERDS"
			}
	...
	bossdevil = {
		...
		title = "ATTENTION, ÇA VA COMMENCER !"
		bullets = [
			{
				text = "À la place du Star Power, tu as du BATTLE POWER"
			}
			...
			{
				text = "Lève le manche de ta guitare à la verticale pour attaquer Lou"
			}
			{
				text = "Tu DOIS le DÉCONCENTRER avant la fin sinon TU PERDS"
			}
	...
	generic = {
		...
		bullets = [
			...
			{
				text = "Lève le manche de ta guitare à la verticale pour attaquer l'autre joueur"
			}
			{
				text = "Tu DOIS DÉCONCENTRER l'adversaire avant la fin ou alors tu passes en MORT SUBITE"
			}
			{
				text = "En MORT SUBITE toutes les attaques deviennent des CHARGES MORTELLES"
			}
		]
		prompt = "Prêt pour le rock ?"
	}
...
script create_battle_helper_menu \{device_num = 0
	...
	add_user_control_helper \{text = "CHOC DES GUITARES"
		button = green
		z = 100}
	add_user_control_helper \{text = "REFUSER"
		button = red
		z = 100}
endscript
