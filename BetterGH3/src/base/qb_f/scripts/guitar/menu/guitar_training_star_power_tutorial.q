...
script training_2_1_show_title 
	training_show_title \{title = "Didacticiel Star Power"}
	begin
...
script training_2_1_start_gem_scroller 
	...
	training_set_lesson_header_text \{text = "LEÇON 1 : STAR COMBOS"}
	training_set_lesson_header_body \{text = "Réussis chaque note du Star Combo pour augmenter ton Star Power."}
...
script training_2_1_explain 
	...
	training_wait_for_sound \{Sound = 'Tutorial_2A_01_lou'
		Wait}
	training_set_task_header_body \{text = "Réussis le Star Combo pour continuer"}
...
script training_2_2_show_whammy 
	Wait \{1
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_text \{text = "LEÇON 2 : VIBRATO"}
	...
	training_set_lesson_header_body \{text = "Après avoir joué une note, bouge le vibrato pour en extraire le Star Power."}
	training_show_lesson_header
	training_set_task_header_body \{text = "Remplis la jauge de Star Power pour continuer."}
	training_show_task_header
...
script training_2_3_start_gem_scroller 
	...
	training_set_lesson_header_text \{text = "LEÇON 3 : LIBÉRER LE STAR POWER"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
	safe_show \{id = lou_icon}
	change \{training_received_star_power = 0}
...
script training_2_3_explain 
	...
	training_set_lesson_header_body \{text = "Lève le manche à la verticale pour activer le Star Power.\\nUne fois activé, tu peux remettre le manche à l'horizontale."}
	training_show_lesson_header
	training_set_task_header_body \{text = "Libère le Star Power avec le manche et joue 8 notes pour continuer"}
	training_show_task_header
...
script training_2_tutorial_complete_message 
	...
	CreateScreenElement {
		...
		pos = (640.0, 350.0)
		font = ($training_font)
		text = "Didacticiel sur le Star Power terminé !"
		scale = 1.0
		rgba = ($training_text_color)
	}
