...
script winport_create_p1_controller_popup 
	create_popup_warning_menu \{title = "Choisir manette"
		textblock = {
			text = "Appuyer sur une touche de la manette à utiliser en mode solo et dans les menus."
			dims = (800.0, 400.0)
			scale = 0.55
		}
		no_background
...
script winport_create_bind_buttons_popup 
	create_popup_warning_menu \{title = "Choisir manette"
		textblock = {
			text = "Appuyer sur une touche de la manette à configurer"
			dims = (800.0, 400.0)
			scale = 0.55
		}
		no_background
...
script create_controller_settings_menu \{popup = 0}
	...
	if (<popup>)
		<p1_l_flip_text> = "Gaucher J1 : DÉSACTIVÉ"
		<p2_l_flip_text> = "Gaucher J2 : DÉSACTIVÉ"
	else
		<p1_l_flip_text> = "Gaucher J1 :"
		<p2_l_flip_text> = "Gaucher J2 :"
	endif
	CreateScreenElement {
		<text_params>
		text = <p1_l_flip_text>
	...
	CreateScreenElement {
		...
		<text_params>
		text = "Voir paramètres par défaut"
		event_handlers = [
