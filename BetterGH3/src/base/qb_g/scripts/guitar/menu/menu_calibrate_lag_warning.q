...
script create_calibrate_lag_warning_menu 
	...
	create_popup_warning_menu {
		textblock = {
			text = "Um die Latenz zu kalibrieren, muss dieser Song neu gestartet werden. Bei einem Neustart gehen alle nichtgespeicherten Fortschritte verloren. Willst du wirklich fortfahren?"
			dims = (800.0, 400.0)
			scale = 0.55
		}
