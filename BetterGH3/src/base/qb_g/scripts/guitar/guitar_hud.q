...
hud_screen_elements = [
	...
	}
	{
		...
		text = "Höhere Schwierigkeitsstufe!"
		pos = (640.0, 300.0)
		scale = 0.7
		just = [
			center
	...
	{
		id = coop_raise_axe
		text = "Gitarre hoch zum Aktivieren"
		pos = (640.0, 300.0)
		scale = 0.7
		just = [
			center
