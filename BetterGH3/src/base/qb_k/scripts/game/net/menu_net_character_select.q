...
script create_leaving_lobby_dialog \{menu_id = leaving_lobby_dialog_menu
	...
	CreateScreenElement {
		...
		text = "현재 게임에서 나가려고 합니다. 정말 게임에서 나가시겠습니까?"
		just = [center top]
		internal_just = [center top]
		z_priority = (<z> + 5)
		pos = (640.0, 310.0)
	...
	if (($ui_flow_manager_state [0]) = online_pause_fs)
		...
		add_user_control_helper text = "선택" button = green z = (<z> - 10)
		add_user_control_helper text = "뒤로" button = red z = (<z> - 10)
		add_user_control_helper text = "위/아래" button = strumbar z = (<z> - 10)
	endif
