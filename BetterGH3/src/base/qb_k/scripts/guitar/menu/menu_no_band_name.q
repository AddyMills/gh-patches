...
no_band_name_messages = [
	"자네가 무슨 프린스라도 되는게 아니라면 이름을 입력하시지."
	"빌@*$#&% 이름을 입력하라고!!!"
	"학교에서 낯을 가리지 않았나? 이름을 입력하라고, 친구."
	"밴드 이름을 입력하지 않을 때마다 고양이들은 죽어나간다고."
	"밴드 이름을 입력하지 않겠나? 기분이 정말 좋군."
	"이름이 없으면 팬들이 어떻게 자네를 부르겠나?"
	"밴드 이름을 하나 제안하지. 게으르고 상상력 없는 밴드 어때?"
	"벌써 왔군!"
]
