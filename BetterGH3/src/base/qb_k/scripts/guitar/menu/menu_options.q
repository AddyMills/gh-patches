...
script create_options_menu 
	...
	displayText parent = om_container text = "옵션" pos = (733.0, 110.0) scale = <titleScale> just = [center center] rgba = [50 0 0 255] font = text_A11_large z = 10 rot = (<rot> -3) noshadow
	displayText parent = om_container text = "옵션" pos = (728.0, 115.0) scale = <titleScale> just = [center center] rgba = [160 130 105 255] font = text_A11_large z = 9 rot = (<rot> -2) noshadow
