...
script training_2_1_show_title 
	training_show_title \{title = "스타의 힘 훈련"}
	begin
...
script training_2_1_start_gem_scroller 
	...
	training_set_lesson_header_text \{text = "강좌 1: 스타 콤보"}
	training_set_lesson_header_body \{text = "스타의 힘을 증폭하려면 스타 콤보의 모든 노트를 연주"}
...
script training_2_1_explain 
	...
	training_wait_for_sound \{Sound = 'Tutorial_2A_01_lou'
		Wait}
	training_set_task_header_body \{text = "계속하려면 스타 콤보 성공"}
...
script training_2_2_show_whammy 
	Wait \{1
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_text \{text = "강좌 2: 와미 바"}
	...
	training_set_lesson_header_body \{text = "스타의 힘을 얻으려면 노트를 연주한 후에 와미 바를 움직이십시오"}
	training_show_lesson_header
	training_set_task_header_body \{text = "계속하려면 스타의 힘 미터 증폭"}
	training_show_task_header
...
script training_2_3_start_gem_scroller 
	...
	training_set_lesson_header_text \{text = "강좌 3: 기울여서 스타의 힘 사용"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
	safe_show \{id = lou_icon}
	change \{training_received_star_power = 0}
...
script training_2_3_explain 
	...
	training_set_lesson_header_body \{text = "기타를 위로 기울여서 스타의 힘을 사용하십시오.\\n사용되면 다시 밑으로 기울이십시오"}
	training_show_lesson_header
	training_set_task_header_body \{text = "계속하려면 기울여서 스타의 힘을 사용하고 8개의 노트 연주"}
	training_show_task_header
