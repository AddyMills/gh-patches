...
script create_online_server_list 
	...
	if (($ui_flow_manager_state [0]) = online_server_list_fs)
		<title_text> = "EXAMINAR CAMPEONATOS"
	...
	add_user_control_helper \{text = "VOLVER"
		button = red
		z = 100}
	add_user_control_helper \{text = "ACTUALIZAR"
		button = Blue
		z = 100}
...
script create_server_list_searching_dialog \{menu_id = server_list_searching_dialog_menu
	...
	add_searching_menu_item vmenu_id = <vmenu_id> choose_script = searching_dialog_select_stop text = "DETENER"
	add_searching_menu_item vmenu_id = <vmenu_id> choose_script = searching_dialog_select_cancel text = "CANCELAR"
	set_focus_color rgba = ($online_dark_purple)
	set_unfocus_color rgba = (online_light_blue)
...
script create_server_list_create_match_dialog \{menu_id = server_list_create_match_dialog_menu
	...
	add_searching_menu_item vmenu_id = <vmenu_id> choose_script = create_match_dialog_select_create text = "CREAR PARTIDA"
	add_searching_menu_item vmenu_id = <vmenu_id> choose_script = create_match_dialog_select_cancel text = "CANCELAR"
