save_changes_message = "Estás a punto de salir de las Opciones del jugador. Si continúas adelante, no se guardarán los cambios que hayas hecho. ¿Quieres GUARDAR los cambios primero?"

script create_online_options_menu \{menu_title = "OPCIONES"
		menu_subtitle = "OPCIONES EN LÍNEA"
