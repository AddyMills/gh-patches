...
artist_text_by = "de"
artist_text_as_made_famous_by = "un clásico de"
permanent_songlist_props = {
	avalancha = {
		checksum = avalancha
		name = 'avalancha'
	...
	bossslash = {
		checksum = bossslash
		name = 'bossslash'
		title = "Guerra de guitarras contra Slash"
		artist = "Slash"
		year = ", 2007"
		artist_text = $artist_text_by
		original_artist = 1
	...
	bosstom = {
		checksum = bosstom
		name = 'bosstom'
		title = "Guerra de guitarras contra Tom Morello"
		artist = "Tom Morello"
		year = ", 2007"
		artist_text = $artist_text_by
		original_artist = 1
	...
	bossdevil = {
		checksum = bossdevil
		name = 'bossdevil'
		title = "Guerra de guitarras contra Lou"
		artist = "The Charlie Daniels Band"
		year = ", 1979"
		artist_text = "inspirado por"
		original_artist = 1
		version = gh3
		leaderboard = 0
		gem_offset = 0
	...
	TalkDirtyToMe = {
		...
		artist = "Poison"
		year = ", 1986"
		artist_text = "con Bret Michaels, un clásico de"
		original_artist = 0
		version = gh3
		leaderboard = 1
		gem_offset = 0
