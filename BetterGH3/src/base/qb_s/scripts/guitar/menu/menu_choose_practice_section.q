...
menu_choose_practice_section_start_text = "ELEGIR SECCIÓN DONDE EMPEZAR"
menu_choose_practice_section_end_text = "ELEGIR SECCIÓN DONDE ACABAR"
...
script menu_choose_practice_section_refresh_entries 
	...
	if ScreenElementExists id = <entry_id>
		if ((<entry> + ($menu_choose_practice_section_base)) = 0)
			SetScreenElementProps id = <entry_id> text = "TEMA ENTERO"
		else
