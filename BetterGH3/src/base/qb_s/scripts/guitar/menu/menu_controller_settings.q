...
script winport_create_p1_controller_popup 
	create_popup_warning_menu \{title = "Seleccionar mando"
		textblock = {
			text = "Pulsa cualquier botón del mando para utilizarlo en el modo para un jugador y en los menús."
			dims = (800.0, 400.0)
			scale = 0.55
		}
		no_background
...
script winport_create_bind_buttons_popup 
	create_popup_warning_menu \{title = "Seleccionar mando"
		textblock = {
			text = "Pulsa cualquier botón en el mando que quieres configurar."
			dims = (800.0, 400.0)
			scale = 0.55
		}
		no_background
...
script create_controller_settings_menu \{popup = 0}
	...
	if (<popup>)
		<p1_l_flip_text> = "Camb. zurdo J1: DESACT."
		<p2_l_flip_text> = "Camb. zurdo J2: DESACT."
	else
		<p1_l_flip_text> = "Camb. zurdo J1:"
		<p2_l_flip_text> = "Camb. zurdo J2:"
	endif
	CreateScreenElement {
		<text_params>
		text = <p1_l_flip_text>
