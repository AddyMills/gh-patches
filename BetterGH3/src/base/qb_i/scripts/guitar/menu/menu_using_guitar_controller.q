...
script menu_using_guitar_controller_add_text_header 
	text1 = "IN CASO DI ROCK"
	text1_pos = (660.0, 55.0)
	if ($menu_using_guitar_controller_kb = 1)
		text2 = "UTILIZZO DELLA TASTIERA E DEL MOUSE"
	else
		text2 = "USARE LA CHITARRA"
	endif
