cash_deduction_types = [
	{
		desc = "AUTO INCENDIATE"
		val = 2500
	}
	{
		desc = "LOCANDINE RUBATE"
		val = 80
	}
	{
		desc = "CAMERINI DISTRUTTI"
		val = 210
	}
	{
		desc = "MULTE PER IL RUMORE"
		val = 550
	}
	{
		desc = "STANZA D'ALBERGO, IN DISORDINE"
		val = 330
	}
	{
		desc = "DRINK BEVUTI"
...
review_string_3star = "Recensione mediocre: 3 stelle. Ecco il compenso."
review_string_4star = "Recensione buona da 4 stelle. Ecco il tuo compenso."
review_string_5star = "Recensione favolosa: 5 stelle. Ecco il compenso."
...
script create_cash_reward_menu 
	...
	CreateScreenElement {
		...
		scale = 0.7
		pos = (355.0, 140.0)
		text = "Vai a comprarti qualcosa di carino!"
		font = ($cash_reward_font)
		rgba = [0 0 0 255]
		just = [left top]
		z_priority = 3
	...
	CreateScreenElement {
		...
		scale = 0.8
		pos = (880.0, 460.0)
		text = "Spendi la tua sudata paga"
		font = ($cash_reward_font)
		rgba = [0 0 0 255]
		just = [right top]
		z_priority = 3
