...
artist_text_by = "di"
artist_text_as_made_famous_by = "nella versione resa famosa da"
permanent_songlist_props = {
	avalancha = {
		checksum = avalancha
		name = 'avalancha'
	...
	bossslash = {
		checksum = bossslash
		name = 'bossslash'
		title = "Battaglia tra chitarre con Slash"
		artist = "Slash"
		year = ", 2007"
		artist_text = $artist_text_by
		original_artist = 1
	...
	bosstom = {
		checksum = bosstom
		name = 'bosstom'
		title = "Battaglia tra chitarre con Tom Morello"
		artist = "Tom Morello"
		year = ", 2007"
		artist_text = $artist_text_by
		original_artist = 1
	...
	bossdevil = {
		checksum = bossdevil
		name = 'bossdevil'
		title = "Battaglia tra chitarre con Lou"
		artist = "The Charlie Daniels Band"
		year = ", 1979"
		artist_text = "ispirata da"
		original_artist = 1
		version = gh3
		leaderboard = 0
		gem_offset = 0
	...
	TalkDirtyToMe = {
		...
		artist = "Poison"
		year = ", 1986"
		artist_text = "con Bret Michaels, nella versione resa famosa da"
		original_artist = 0
		version = gh3
		leaderboard = 1
		gem_offset = 0
