...
battlemode_powerups = [
	{
		name = lightning
		name_text = "Amplificador sobrecargado"
		weight = 10
		weight_low = 0
		weight_losing = 0
	...
	{
		name = LeftyNotes
		name_text = "Giro izquierdo"
		alt_name_text = "Giro derecho"
		weight = 10
		weight_low = 0
		weight_losing = 10
