...
GH3_Career_Songs = {
	...
	tier2 = {
		title = "2. Tu primera actuación de verdad"
		songs = [
			mississippiqueen
			schoolsout
			sunshineofyourlove
	...
	tier3 = {
		title = "3. La grabación del vídeo"
		songs = [
			whenyouwereyoung
			missmurder
			theseeker
	...
	tier6 = {
		title = "6. Los mejores sobre la faz de la Tierra"
		songs = [
			blackmagicwoman
			cherubrock
			blacksunshine
