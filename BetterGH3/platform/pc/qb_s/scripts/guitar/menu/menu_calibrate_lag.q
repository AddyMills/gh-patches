...
script create_calibrate_lag_menu \{from_in_game = 1}
	...
	displayText \{parent = cl_container
		...
		noshadow}
	upper_helper = "Algunos televisores de alta definición (HDTV) tienen un retraso de audio/vídeo que dificulta el juego."
	lower_helper = "Rasguea las notas cuando estén en el objetivo."
	CreateScreenElement {
