...
script training_basic_tutorial_show_title 
	training_show_title \{title = "Tutorial básico de Guitar Hero"}
	begin
...
script training_1_1_show_lesson_header 
	training_set_lesson_header_text \{text = "LECCIÓN 1: AFINAR GUITARRA"}
	training_set_lesson_header_body \{text = "1. PULSA el botón de traste para ELEGIR la nota.\\n2. PULSA la barra de toque para TOCAR la nota."}
	training_set_task_header_body \{text = "Toca cada nota tres veces para continuar."}
...
script training_1_2_start_gem_scroller 
	...
	training_set_lesson_header_text \{text = "LECCIÓN 2: TOCAR NOTAS"}
	training_set_lesson_header_body \{text = "1. Cuando las notas crucen la línea, tócalas en la guitarra."}
	training_show_lesson_header
	safe_show \{id = god_icon}
endscript
...
script training_1_2_show_lesson 
	...
	Wait \{6
		seconds
		ignoreslomo}
	training_set_task_header_body \{text = "Toca 8 notas para continuar."}
	training_show_task_header
...
script training_1_3_show_lesson 
	Wait \{1
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_text \{text = "LECCIÓN 3: NOTAS DISPARES"}
	training_set_lesson_header_body \{text = "1. Haz coincidir los colores para tocar notas distintas."}
	training_show_lesson_header
	safe_show \{id = god_icon}
	training_play_sound \{Sound = 'Tutorial_1C_01_God'
		Wait}
	training_set_task_header_body \{text = "Toca algunas notas dispares y acierta ocho para continuar."}
	training_show_task_header
	Wait \{2
		seconds
		ignoreslomo}
...
script training_1_4_start_gem_scroller 
	...
	training_set_lesson_header_text \{text = "LECCIÓN 4: NOTAS LARGAS"}
...
script training_1_4_show_lesson 
	Wait \{3.55
		...
		ignoreslowmo}
	training_pause_gem_scroller
	training_set_lesson_header_body \{text = "1. Mantén pulsado el botón de traste.\\n2. Rasguea\\n3. Mantén pulsado el botón de traste."}
	training_show_lesson_header
	...
	training_wait_for_sound \{Sound = 'Tutorial_1D_01_God'
		Wait}
	training_set_task_header_body \{text = "Toca ocho notas largas para continuar."}
	training_show_task_header
	training_display_notes_hit \{notes_hit = 0}
	Wait \{2
		seconds
...
script training_1_5_start_gem_scroller 
	...
	training_set_lesson_header_text \{text = "LECCIÓN 5: ACORDES"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
...
script training_1_5_show_lesson 
	Wait \{3.5
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_body \{text = "Dos notas tocadas a la vez."}
	training_show_lesson_header
	...
	training_set_task_header_body \{text = "Toca 8 acordes para continuar."}
	training_show_task_header
	training_display_notes_hit \{notes_hit = 0}
	Wait \{2
		seconds
...
script training_1_6_show_hud 
	training_set_lesson_header_text \{text = "LECCIÓN 6: INTERFAZ DE USUARIO"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
	safe_show \{id = god_icon}
	...
	Wait \{8.0
		seconds
		ignoreslomo}
	training_set_lesson_header_body \{text = "Amarillo = Vas bien"}
	Wait \{5.5
		seconds
		ignoreslomo}
...
script training_1_6_complete 
	...
	CreateScreenElement {
		...
		pos = (640.0, 350.0)
		font = ($training_font)
		text = "¡Tutorial básico completado!"
		scale = 1.0
		rgba = ($training_text_color)
	}
