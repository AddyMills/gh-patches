...
script create_practice_warning_menu 
	...
	if StructureContains Structure = <song_struct> boss
		warning_text = "Tu progreso en este tema se perderá si sales al tutorial ahora. ¿Estás seguro de que quieres salir?"
		goto_text = "TUTORIAL"
	else
		warning_text = "Tu progreso en este tema se perderá si sales al modo Práctica ahora. ¿Seguro que quieres salir?"
		goto_text = "PRÁCTICA"
	endif
