...
script training_3_show_title 
	training_show_title \{title = "Tutorial de Guerra de guitarras"}
	begin
...
script training_3_1_show_lesson 
	...
	training_set_lesson_header_text \{text = "LECCIÓN 1: CONSEGUIR ATAQUES"}
	training_set_lesson_header_body \{text = "1. Completa una serie de notas de guerra para recibir un ataque para el modo Guerra de guitarras."}
	training_show_lesson_header
	safe_show \{id = god_icon}
	training_play_sound \{Sound = 'Tutorial_3A_01_God'
		Wait}
	training_set_task_header_body \{text = "Acierta la serie de estrellas para continuar"}
...
script training_3_2_show_lesson 
	...
	change \{structurename = player1_status
		star_power_usable = 0}
	training_set_lesson_header_text \{text = "LECCIÓN 2: UTILIZAR ATAQUES"}
	...
	training_set_task_header_body \{text = "Levanta la guitarra para lanzar el ataque."}
	training_show_task_header
	Wait \{2
		seconds
		ignoreslomo}
...
script training_3_3_show_lesson 
	...
	Wait \{1.0
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_text \{text = "LECCIÓN 3: ATAQUES DIFERENTES"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
	training_hide_task_header
	safe_show \{id = god_icon}
	training_play_sound \{Sound = 'Tutorial_3C_01_God'
		Wait}
	training_set_task_header_body \{text = "Pulsa rápidamente el botón de traste de la cuerda rota."}
	training_show_task_header
	Wait \{1
		seconds
		ignoreslomo}
...
script training_3_4_show_lesson 
	Wait \{1
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_text \{text = "LECCIÓN 4: ATAQUES MÚLTIPLES"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
	training_hide_task_header
	safe_show \{id = lou_icon}
	...
	training_play_sound \{Sound = 'Tutorial_3D_01_Lou'
		Wait}
	training_set_task_header_body \{text = "Utiliza ambos ataques para dañar a tu contrincante."}
	training_show_task_header
	change \{structurename = player1_status
		current_num_powerups = 0}
	bossbattle_ready \{battle_gem = 0
...
script training_3_4_show_complete_message 
	...
	CreateScreenElement {
		...
		pos = (640.0, 350.0)
		font = ($training_font)
		text = "Tutorial de Guerra de guitarras completado"
		scale = 1.0
		rgba = ($training_text_color)
	}
	Wait \{0.5
