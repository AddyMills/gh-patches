...
script winport_create_calibrate_lag_menu \{from_in_game = 1}
	...
	upper_helper = "Esta opción puede tener un valor entre 0 ms y 200 ms.\\n\\nAlgunos elementos de hardware pueden hacer que el sonido y el juego no estén sincronizados. Si ves que tocas las notas anticipándote a la música, intenta añadir 20 ms al valor. Si notas que tocas con retraso, resta 20 ms. Ajusta el número según tus preferencias personales."
	CreateScreenElement {
...
script winport_menu_calibrate_lag_create_circles 
	...
	add_user_control_helper \{text = "RASGUEA"
		button = strumbar
		z = 100}
	destroy_menu \{menu_id = winport_cl_scroll}
...
script winport_menu_calibrate_lag_say_lines_are_even 
	...
	output_log_text "Calibrar: %o" o = <new_input_diff> color = white
...
script winport_create_audio_calibrate_reminder 
	...
	CreateScreenElement {
		...
		pos = (640.0, 270.0)
		dims = (500.0, 500.0)
		text = "Prueba la calibración de sonido en el menú Opciones."
		scale = 0.8
	}
	CreateScreenElement {
		<textProps>
		pos = (640.0, 420.0)
		dims = (650.0, 500.0)
		text = "Para adaptar el juego al hardware de tu ordenador, utiliza la opción Calibrar retraso del menú Opciones."
		scale = 0.7
	}
