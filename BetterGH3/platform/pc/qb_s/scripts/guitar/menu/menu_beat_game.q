beat_game_title = "\\c6¡TE PASASTE GUITAR HERO III EN NIVEL \\c0%d\\c6!\\c0"
beat_game_message = "¿Crees que tienes lo que hay que tener\\n para dejarlos alucinados? Ponte a prueba en \\c1%n\\c0. Puede que haya una recompensa si lo consigues. Dolor, fama y gloria esperan, pequeño rockero."
beat_game_message_expert = "Guau. Has dominado el nivel experto: ¡forma un grupo YA! ¡Pasa al siguiente nivel con \\c1%n\\c0! En el menú Opciones podrás desbloquear trucos."
...
script create_beat_game_menu 
	...
	difficulty_text = "EXPERTO"
	next_difficulty_text = "TRUCO MODO PRECISIÓN"
	...
	switch (<difficulty>)
		...
		<next_difficulty_text> = "DIFÍCIL"
		case hard
		<difficulty_text> = "DIFÍCIL"
		next_difficulty = expert
		<next_difficulty_text> = "EXPERTO"
	endswitch
	...
	<cheat> = "RIFF 'ROCK YOU LIKE A HURRICANE' x 2"
	FormatText TextName = cheat_text "PISTA DE TRUCO: %c" c = <cheat>
	if (<difficulty> = expert)
		CreateScreenElement {
			type = TextElement
			parent = beat_game_container
