GH3_CoopCareer_Songs = {
	...
	tier2 = {
		title = "2. Lo único que queremos es ser famosos"
		songs = [
			schoolsout
			koolthing
			missmurder
	...
	tier4 = {
		title = "4. El grupo vuelve a los escenarios"
		songs = [
			holidayincambodia
			blackmagicwoman
			sameoldsonganddance
	...
	tier6 = {
		title = "6. Luchad por vuestras almas"
		songs = [
			knightsofcydonia
			ONE
			numberofthebeast
