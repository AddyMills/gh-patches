...
script net_add_basic_stats 
	...
	if ($game_mode = p2_coop)
		...
		add_text_to_column column = <desc_column> text = "VENCE"
	endif
	add_text_to_column column = <desc_column> text = "MEJOR RACHA"
	add_text_to_column column = <desc_column> text = "MEJOR PUNTUACIÓN"
endscript
