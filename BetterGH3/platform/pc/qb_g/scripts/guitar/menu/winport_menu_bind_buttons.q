...
winport_bb_kb_menuItems = [
	{
		text = "Grüner Bund/Bestätigen"
		handler = winport_bb_choose_control
		actionNum = 0
	}
	{
		text = "Roter Bund/Abbrechen"
		handler = winport_bb_choose_control
		actionNum = 1
	}
	{
	...
	{
		text = "Anschlagschalter auf/Im Menü auf"
		handler = winport_bb_choose_control
		actionNum = 10
	}
	{
		text = "Anschlagschalter ab/Im Menü ab"
		handler = winport_bb_choose_control
		actionNum = 9
	}
	{
	...
	{
		text = "Auf Standard-Tastatur/Standard-Maus zurücksetzen"
		handler = winport_bb_reset_to_config1
	}
	{
		text = "Auf Standard-Tastatur zurücksetzen"
