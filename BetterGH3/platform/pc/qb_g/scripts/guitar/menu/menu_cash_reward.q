cash_deduction_types = [
	{
		desc = "AUTOS, ANGEZÜNDET"
		val = 2500
	}
	{
		desc = "KUNSTWERKE, GEKLAUT"
		val = 80
	}
	{
		desc = "UMKLEIDE, ZERTRÜMMERT"
		val = 210
	}
	{
		desc = "LÄRM-BUSSGELDER, BEZAHLT"
		val = 550
	}
	{
		desc = "HOTELZIMMER, VERWÜSTET"
		val = 330
	}
	{
		desc = "DRINKS, KONSUMIERT"
		val = 300
	}
]
review_string_3star = "Hübsche 3-Sterne-Kritik. Das ist dein Anteil."
review_string_4star = "Gute 4-Sterne-Kritik. Das ist dein Anteil."
review_string_5star = "Klasse 5-Sterne-Kritik. Das ist dein Anteil."
