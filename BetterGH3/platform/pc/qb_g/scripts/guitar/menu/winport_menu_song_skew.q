...
script winport_create_calibrate_lag_menu \{from_in_game = 1}
	...
	upper_helper = "Dieser Wert kann auf 0 ms bis 200 ms eingestellt werden.\\n\\nManche Computer-Hardware kann dazu führen, dass Sound und Gameplay nicht mehr synchron sind. Wenn du Noten vor der Musik spielen musst, versuche, den Wert um 20 ms zu erhöhen. Wenn du hinter der Musik zurückbleibst, reduziere den Wert um 20 ms.  Anschließend versuche eine genaue Einstellung des Werts."
	CreateScreenElement {
...
script winport_menu_calibrate_lag_create_circles 
	...
	add_user_control_helper \{text = "SCHLAG AN"
		button = strumbar
		z = 100}
	destroy_menu \{menu_id = winport_cl_scroll}
...
script winport_menu_calibrate_lag_say_lines_are_even 
	...
	output_log_text "Kalibrieren: %o" o = <new_input_diff> color = white
...
script winport_create_audio_calibrate_reminder 
	...
	CreateScreenElement {
		...
		pos = (640.0, 270.0)
		dims = (500.0, 500.0)
		text = "Schau dir die Sound-Kalibrierung im Optionsmenü an."
		scale = 0.8
	}
	CreateScreenElement {
		<textProps>
		pos = (640.0, 420.0)
		dims = (650.0, 500.0)
		text = "Um das Spielerlebnis mit deiner besonderen Computer-Hardware zu optimieren, benutze das Tool Sound-Latenz kalibrieren im Optionsmenü."
		scale = 0.7
	}
