...
script training_2_1_show_title 
	training_show_title \{title = "Starpower-Tutorial"}
	begin
...
script training_2_1_start_gem_scroller 
	...
	training_set_lesson_header_text \{text = "LEKTION 1: STAR COMBOS"}
	training_set_lesson_header_body \{text = "Triff jede Note einer Sternencombo für einen Starpower-Bonus"}
...
script training_2_1_explain 
	...
	training_wait_for_sound \{Sound = 'Tutorial_2A_01_lou'
		Wait}
	training_set_task_header_body \{text = "Meistere die Sternencombo, um fortzufahren"}
...
script training_2_2_show_whammy 
	Wait \{1
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_text \{text = "LEKTION 2: TREMOLO"}
	...
	training_set_lesson_header_body \{text = "Nach dem Spielen einer Note bewegst du das Tremolo, um Starpower zu sammeln."}
	training_show_lesson_header
	training_set_task_header_body \{text = "Treib die Starpower-Anzeige in die Höhe, um fortzufahren."}
	training_show_task_header
...
script training_2_3_start_gem_scroller 
	...
	training_set_lesson_header_text \{text = "LEKTION 3: STARPOWER AKTIVIEREN"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
	safe_show \{id = lou_icon}
	change \{training_received_star_power = 0}
...
script training_2_3_explain 
	...
	training_set_lesson_header_body \{text = "Zieh die Gitarre hoch und aktiviere Starpower.\\nNach dem Aktivieren kann sie wieder runtergezogen werden."}
	training_show_lesson_header
	training_set_task_header_body \{text = "Aktiviere deine Starpower und triff 8 Noten, um fortzufahren"}
	training_show_task_header
...
script training_2_tutorial_complete_message 
	...
	CreateScreenElement {
		...
		pos = (640.0, 350.0)
		font = ($training_font)
		text = "Starpower-Tutorial beendet!"
		scale = 1.0
		rgba = ($training_text_color)
	}
