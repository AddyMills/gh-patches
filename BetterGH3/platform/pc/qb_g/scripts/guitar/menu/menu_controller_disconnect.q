...
script create_controller_disconnect_menu 
	...
	if ($playing_song = 1)
		...
		menu_z = 1000
		rocking_out_text = "DU LÄSST ES ZU HEFTIG ANGEHEN"
		...
		FormatText \{TextName = please_reconnect_text
			"Stell sicher, dass alle Controller korrekt angeschlossen sind."}
		...
		displayText {
			...
			text = "DEN CONTROLLER BITTE ERNEUT ANSCHLIESSEN"
