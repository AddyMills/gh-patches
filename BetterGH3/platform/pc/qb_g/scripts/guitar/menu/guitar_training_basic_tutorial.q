...
script training_basic_tutorial_show_title 
	training_show_title \{title = "Guitar Hero Grundlagen Tutorial"}
	begin
...
script training_1_1_show_lesson_header 
	training_set_lesson_header_text \{text = "LEKTION 1: GITARRE STIMMEN"}
	training_set_lesson_header_body \{text = "1. Grifftaste HALTEN, um die Note zu WÄHLEN.\\n2. Zum SPIELEN Anschlagschalter nach oben/unten DRÜCKEN."}
	training_set_task_header_body \{text = "Jede Note 3 Mal spielen, um fortzufahren."}
...
script training_1_2_start_gem_scroller 
	...
	training_set_lesson_header_text \{text = "LEKTION 2: NOTEN SPIELEN"}
	training_set_lesson_header_body \{text = "1. Spiel die Noten, wenn sie über die Linie laufen."}
	training_show_lesson_header
	safe_show \{id = god_icon}
endscript
...
script training_1_2_show_lesson 
	...
	Wait \{6
		seconds
		ignoreslomo}
	training_set_task_header_body \{text = "Spiel 8 Noten, um fortzufahren."}
	training_show_task_header
...
script training_1_3_show_lesson 
	Wait \{1
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_text \{text = "LEKTION 3: DIVERSE NOTEN"}
	training_set_lesson_header_body \{text = "1. Triff die passenden Notenfarben."}
	training_show_lesson_header
	safe_show \{id = god_icon}
	training_play_sound \{Sound = 'Tutorial_1C_01_God'
		Wait}
	training_set_task_header_body \{text = "Spiel noch ein paar Noten, triff 8, um fortzufahren."}
	training_show_task_header
	Wait \{2
		seconds
		ignoreslomo}
...
script training_1_4_start_gem_scroller 
	...
	training_set_lesson_header_text \{text = "LEKTION 4: LANGE NOTEN"}
...
script training_1_4_show_lesson 
	Wait \{3.55
		...
		ignoreslowmo}
	training_pause_gem_scroller
	training_set_lesson_header_body \{text = "1. Halte eine Grifftaste gedrückt.\\n2. Schlag an.\\n3. Lass die Grifftaste nicht vor Ende der Note los."}
	training_show_lesson_header
	...
	training_wait_for_sound \{Sound = 'Tutorial_1D_01_God'
		Wait}
	training_set_task_header_body \{text = "Spiel 8 lange Noten, um fortzufahren"}
	training_show_task_header
	training_display_notes_hit \{notes_hit = 0}
	Wait \{2
		seconds
...
script training_1_5_start_gem_scroller 
	...
	training_set_lesson_header_text \{text = "LEKTION 5: AKKORDE"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
...
script training_1_5_show_lesson 
	Wait \{3.5
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_body \{text = "Zwei Noten gleichzeitig gespielt"}
	training_show_lesson_header
	...
	training_set_task_header_body \{text = "Spiel 8 Akkorde, um fortzufahren"}
	training_show_task_header
	training_display_notes_hit \{notes_hit = 0}
	Wait \{2
		seconds
...
script training_1_6_show_hud 
	training_set_lesson_header_text \{text = "LEKTION 6: SPIELOBERFLÄCHE"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
	safe_show \{id = god_icon}
	...
	Wait \{8.0
		seconds
		ignoreslomo}
	training_set_lesson_header_body \{text = "Gelb = Leistung OK"}
	Wait \{5.5
		seconds
		ignoreslomo}
...
script training_1_6_complete 
	...
	CreateScreenElement {
		...
		pos = (640.0, 350.0)
		font = ($training_font)
		text = "Grundlagen-Tutorial beendet!"
		scale = 1.0
		rgba = ($training_text_color)
	}
