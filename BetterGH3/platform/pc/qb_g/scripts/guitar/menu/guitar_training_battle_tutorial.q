...
script training_3_1_show_lesson 
	...
	training_set_lesson_header_text \{text = "LEKTION 1: POWERUPS ERLANGEN"}
	training_set_lesson_header_body \{text = "1. Meistere eine Battlepower-Sequenz und hol dir so ein Gitarrenschlacht-Power-Up."}
	training_show_lesson_header
	safe_show \{id = god_icon}
	training_play_sound \{Sound = 'Tutorial_3A_01_God'
		Wait}
	training_set_task_header_body \{text = "Triff die Folge von sternförmigen Noten, um fortzufahren"}
...
script training_3_2_show_lesson 
	...
	change \{structurename = player1_status
		star_power_usable = 0}
	training_set_lesson_header_text \{text = "LEKTION 2: POWERUPS EINSETZEN"}
	...
	training_set_task_header_body \{text = "Zieh die Gitarre hoch, um den Angriff ausführen"}
	training_show_task_header
	Wait \{2
		seconds
		ignoreslomo}
...
script training_3_3_show_lesson 
	...
	Wait \{1.0
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_text \{text = "LEKTION 3: DIVERSE ANGRIFFE"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
	training_hide_task_header
	safe_show \{id = god_icon}
	training_play_sound \{Sound = 'Tutorial_3C_01_God'
		Wait}
	training_set_task_header_body \{text = "Drücke die Taste der gerissenen Saite mehrmals schnell."}
	training_show_task_header
	Wait \{1
		seconds
		ignoreslomo}
...
script training_3_4_show_lesson 
	Wait \{1
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_text \{text = "LEKTION 4: MEHRFACHE ANGRIFFE"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
	training_hide_task_header
	safe_show \{id = lou_icon}
	...
	training_play_sound \{Sound = 'Tutorial_3D_01_Lou'
		Wait}
	training_set_task_header_body \{text = "Nutze beide Angriffe zum Schädigen des Gegners"}
	training_show_task_header
	change \{structurename = player1_status
		current_num_powerups = 0}
	bossbattle_ready \{battle_gem = 0
...
script training_3_4_show_complete_message 
	...
	CreateScreenElement {
		...
		pos = (640.0, 350.0)
		font = ($training_font)
		text = "Gitarrenschlacht Tutorial beendet!"
		scale = 1.0
		rgba = ($training_text_color)
	}
	Wait \{0.5
