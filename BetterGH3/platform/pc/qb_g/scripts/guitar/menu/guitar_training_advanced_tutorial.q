...
script training_4_1_show_title 
	training_show_title \{title = "Hammer-On und Pull-Off Tutorial"}
	begin
...
script training_4_1_explain 
	training_set_lesson_header_text \{text = "LEKTION 1: SAITEN-GRUNDLAGEN"}
...
script training_4_2_explain 
	training_set_lesson_header_text \{text = "LEKTION 2: HAMMER-ON-FINGERSATZ"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
endscript
...
script training_4_2_zoom_guitar 
	training_set_lesson_header_body \{text = "1. Schlag Grün wie immer an.\\n2. Drück Rot (ohne Anschlag).\\n3. Drück Gelb (ohne Anschlag)."}
	training_show_lesson_header
	training_set_task_header_body \{text = "Triff 3 Hammer-On Folgen, um fortzufahren."}
...
script training_4_3_start_gem_scroller 
	destroy_band
	training_set_lesson_header_text \{text = "LEKTION 3: HAMMER-ONS"}
	training_set_lesson_header_body \{text = "1.  Hammer-Ons üben"}
	training_show_lesson_header
	safe_show \{id = god_icon}
...
script training_4_3_explain 
	...
	training_play_sound \{Sound = 'Tutorial_4c_01_God'
		Wait}
	training_set_task_header_body \{text = "Triff 8 Noten mit der Hammer-On-Technik."}
	training_show_task_header
...
script training_4_4_explain 
	training_set_lesson_header_text \{text = "LEKTION 4: PULL-OFF-FINGERSATZ"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
...
script training_4_4_zoom_guitar 
	training_set_lesson_header_body \{text = "1. Schlag Gelb wie immer an.\\n2. Lass Rot los (ohne Anschlag).\\n3. Lass Grün los (ohne Anschlag)."}
	training_show_lesson_header
	training_set_task_header_body \{text = "Triff 3 Pull-Off-Folgen, um fortzufahren."}
	training_show_task_header
	hide_strum_fingers
	hide_fret_fingers
	if ScreenElementExists \{id = guitar_sprite}
...
script training_4_5_start_gem_scroller 
	destroy_band
	training_set_lesson_header_text \{text = "LEKTION 5: PULL-OFFS"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
	safe_show \{id = lou_icon}
...
script training_4_5_explain 
	Wait \{1
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_body \{text = "1. Pull-Offs üben"}
	training_show_lesson_header
	training_set_task_header_body \{text = "Triff 8 Noten mit der Pull-Off-Technik, um fortzufahren."}
	training_show_task_header
	training_display_notes_hit \{notes_hit = 0}
...
script training_4_5_complete_message 
	...
	CreateScreenElement {
		...
		pos = (640.0, 350.0)
		font = ($training_font)
		text = "Tutorial 'Erweiterte Techniken' beendet!"
		scale = 1.0
		rgba = ($training_text_color)
	}
