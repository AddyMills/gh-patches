...
script net_add_basic_stats 
	...
	if ($game_mode = p2_coop)
		...
		add_text_to_column column = <desc_column> text = "GEWINNT"
	endif
	add_text_to_column column = <desc_column> text = "BESTE SERIE"
	add_text_to_column column = <desc_column> text = "HÖCHSTER PUNKTESTAND"
endscript
