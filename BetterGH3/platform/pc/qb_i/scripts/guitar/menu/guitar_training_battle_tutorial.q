...
script training_3_show_title 
	training_show_title \{title = "Lezione sulla Battaglia tra chitarre"}
	begin
...
script training_3_1_show_lesson 
	...
	training_set_lesson_header_text \{text = "LEZIONE 1: ACQUISIRE POWER-UP"}
	training_set_lesson_header_body \{text = "1. Completa una sequenza Battle Power per ricevere un power-up per la battaglia"}
	training_show_lesson_header
	safe_show \{id = god_icon}
	training_play_sound \{Sound = 'Tutorial_3A_01_God'
		Wait}
	training_set_task_header_body \{text = "Suona la sequenza di stelle per continuare"}
...
script training_3_2_show_lesson 
	...
	change \{structurename = player1_status
		star_power_usable = 0}
	training_set_lesson_header_text \{text = "LEZIONE 2: UTILIZZARE I POWER-UP"}
	...
	training_set_task_header_body \{text = "Inclina la chitarra in posizione verticale per sferrare un attacco"}
	training_show_task_header
	Wait \{2
		seconds
		ignoreslomo}
...
script training_3_3_show_lesson 
	...
	Wait \{1.0
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_text \{text = "LEZIONE 3: ATTACCHI DIVERSI"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
	training_hide_task_header
	safe_show \{id = god_icon}
	training_play_sound \{Sound = 'Tutorial_3C_01_God'
		Wait}
	training_set_task_header_body \{text = "Premi rapidamente il tasto della corda rotta"}
	training_show_task_header
	Wait \{1
		seconds
		ignoreslomo}
...
script training_3_4_show_lesson 
	Wait \{1
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_text \{text = "LEZIONE 4: ATTACCHI MULTIPLI"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
	training_hide_task_header
	safe_show \{id = lou_icon}
	...
	training_play_sound \{Sound = 'Tutorial_3D_01_Lou'
		Wait}
	training_set_task_header_body \{text = "Usa entrambi gli attacchi per danneggiare l'avversario"}
	training_show_task_header
	change \{structurename = player1_status
		current_num_powerups = 0}
	bossbattle_ready \{battle_gem = 0
...
script training_3_4_show_complete_message 
	...
	CreateScreenElement {
		...
		pos = (640.0, 350.0)
		font = ($training_font)
		text = "Lezione sulla Battaglia tra chitarre completata"
		scale = 1.0
		rgba = ($training_text_color)
	}
	Wait \{0.5
