...
script winport_create_p1_controller_popup 
	create_popup_warning_menu \{title = "Scegli controller"
		textblock = {
			text = "Premi qualsiasi tasto sul controller da usare in modalità Gioc. singolo e nei menu."
			dims = (800.0, 400.0)
			scale = 0.55
		}
		no_background
...
script winport_create_bind_buttons_popup 
	create_popup_warning_menu \{title = "Scegli controller"
		textblock = {
			text = "Premi qualsiasi pulsante del controller che vuoi configurare."
			dims = (800.0, 400.0)
			scale = 0.55
		}
		no_background
...
script create_controller_settings_menu \{popup = 0}
	...
	if (<popup>)
		<p1_l_flip_text> = "Giocatore 1 mancino: OFF"
		<p2_l_flip_text> = "Giocatore 2 mancino: OFF"
	else
		<p1_l_flip_text> = "G1 mancino:"
		<p2_l_flip_text> = "G2 mancino:"
	endif
	CreateScreenElement {
		<text_params>
		text = <p1_l_flip_text>
