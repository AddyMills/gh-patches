...
script training_create_lesson_and_task_headers 
	...
	CreateScreenElement {
		...
		dims = <dims>
		font = ($training_font)
		text = "Sostituto temporaneo per il doppiaggio."
		scale = <scale>
		rgba = ($training_text_color)
	}
endscript
...
script training_display_notes_hit 
	FormatText TextName = hit_text "Note suonate %a / 8" a = <notes_hit>
