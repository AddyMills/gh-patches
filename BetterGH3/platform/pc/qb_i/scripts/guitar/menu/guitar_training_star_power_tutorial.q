...
script training_2_1_show_title 
	training_show_title \{title = "Lezione sullo Star Power"}
	begin
...
script training_2_1_start_gem_scroller 
	...
	training_set_lesson_header_text \{text = "LEZIONE 1: COMBO DI STELLE"}
	training_set_lesson_header_body \{text = "Per accumulare Star Power suona tutte le note di una combo"}
...
script training_2_1_explain 
	...
	training_wait_for_sound \{Sound = 'Tutorial_2A_01_lou'
		Wait}
	training_set_task_header_body \{text = "Suona tutta la combo di stelle per continuare"}
...
script training_2_2_show_whammy 
	Wait \{1
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_text \{text = "LEZIONE 2: LEVA VIBRATO"}
	...
	training_set_lesson_header_body \{text = "Dopo aver suonato una nota, muovi la leva vibrato su e giù per accumulare Star Power"}
	training_show_lesson_header
	training_set_task_header_body \{text = "Alimenta l'indicatore dello Star Power per continuare"}
	training_show_task_header
...
script training_2_3_start_gem_scroller 
	...
	training_set_lesson_header_text \{text = "LEZIONE 3: USARE LO STAR POWER"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
	safe_show \{id = lou_icon}
	change \{training_received_star_power = 0}
...
script training_2_3_explain 
	...
	training_set_lesson_header_body \{text = "Inclina la chitarra in verticale per attivare lo Star Power.\\nUna volta attivato, potrai riportare la chitarra nella posizione iniziale"}
	training_show_lesson_header
	training_set_task_header_body \{text = "Inclina la chitarra per attivare lo Star Power e suona 8 note"}
	training_show_task_header
...
script training_2_tutorial_complete_message 
	...
	CreateScreenElement {
		...
		pos = (640.0, 350.0)
		font = ($training_font)
		text = "Lezione sullo Star Power completata!"
		scale = 1.0
		rgba = ($training_text_color)
	}
