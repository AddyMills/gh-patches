...
script training_4_1_show_title 
	training_show_title \{title = "Lezione su Hammer-on e Pull-off"}
	begin
...
script training_4_1_explain 
	training_set_lesson_header_text \{text = "LEZIONE 1: NOZIONI DI BASE SULLE CORDE"}
...
script training_4_2_explain 
	training_set_lesson_header_text \{text = "LEZIONE 2: TECNICA DELL'HAMMER-ON"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
endscript
...
script training_4_2_zoom_guitar 
	training_set_lesson_header_body \{text = "1. Suona il Verde normalmente (pennata)\\n2. Premi il Rosso (non dare pennata)\\n3. Premi il Giallo (non dare pennata)"}
	training_show_lesson_header
	training_set_task_header_body \{text = "Suona 3 sequenze di Hammer-on"}
...
script training_4_3_start_gem_scroller 
	destroy_band
	training_set_lesson_header_text \{text = "LEZIONE 3: HAMMER-ON"}
	training_set_lesson_header_body \{text = "1.  Esercitati negli Hammer-on"}
	training_show_lesson_header
	safe_show \{id = god_icon}
...
script training_4_3_explain 
	...
	training_play_sound \{Sound = 'Tutorial_4c_01_God'
		Wait}
	training_set_task_header_body \{text = "Suona 8 note usando la tecnica Hammer-on"}
	training_show_task_header
...
script training_4_4_explain 
	training_set_lesson_header_text \{text = "LEZIONE 4: TECNICA DEL PULL-OFF"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
...
script training_4_4_zoom_guitar 
	training_set_lesson_header_body \{text = "1. Suona il Giallo normalmente (pennata)\\n2. Lascia il Rosso (non dare pennata)\\n3. Lascia il Verde (non dare pennata)"}
	training_show_lesson_header
	training_set_task_header_body \{text = "Suona 3 sequenze Pull-off per continuare"}
	training_show_task_header
	hide_strum_fingers
	hide_fret_fingers
	if ScreenElementExists \{id = guitar_sprite}
...
script training_4_5_start_gem_scroller 
	destroy_band
	training_set_lesson_header_text \{text = "LEZIONE 5: PULL-OFF"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
	safe_show \{id = lou_icon}
...
script training_4_5_explain 
	Wait \{1
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_body \{text = "1. Esercitati nei Pull-off"}
	training_show_lesson_header
	training_set_task_header_body \{text = "Suona 8 note con i Pull-off per continuare"}
	training_show_task_header
	training_display_notes_hit \{notes_hit = 0}
...
script training_4_5_complete_message 
	...
	CreateScreenElement {
		...
		pos = (640.0, 350.0)
		font = ($training_font)
		text = "Lezione sulle tecniche avanzate completata!"
		scale = 1.0
		rgba = ($training_text_color)
	}
