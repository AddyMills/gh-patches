...
script create_cheats_menu 
	...
	if ($entering_cheat = 0)
		...
		switch <platform>
			...
			warning_cont = "Inoltre, non sarà possibile ottenere gli obiettivi e inviare i risultati alle classifiche online."
			case ps3
			warning = "ATTENZIONE. Alcuni cheat attivati non funzionano nelle modalità carriera e online."
...
script cheats_zoomin_guitar 
	...
	add_user_control_helper \{text = "FATTO"
		button = start
		z = 100
		fit_to_rectangle = 0}
