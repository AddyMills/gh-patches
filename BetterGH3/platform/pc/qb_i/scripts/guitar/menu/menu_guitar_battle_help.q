...
battle_explanation_text = {
	bossslash = {
		...
		title = "SLASH VUOLE COMBATTERE!"
		bullets = [
			{
				text = "Invece dello Star Power, avrai il BATTLE POWER"
			}
			{
				text = "Suona le GEMME per ottenere un POWER-UP"
			}
			{
				text = "Inclina la chitarra in posizione verticale per attaccare Slash e sconfiggerlo"
			}
			{
				text = "DEVI BATTERLO prima della fine della partita o PERDERAI"
			}
			{
				text = "Attenzione, può rispondere all'attacco!"
			}
		]
		prompt = "Pronto per un po' di rock?"
	}
	bosstom = {
		image = battle_help_boss_bg_morello
		title = "MORELLO TI SFIDA!"
		bullets = [
			{
				text = "Invece dello Star Power, avrai il BATTLE POWER"
			}
			...
			{
				text = "Inclina la chitarra in posizione verticale per attaccare Tom e sconfiggerlo"
			}
			{
				text = "DEVI BATTERLO prima della fine della partita o PERDERAI"
			}
	...
	bossdevil = {
		...
		bullets = [
			...
			{
				text = "Inclina la chitarra in posizione verticale per attaccare Lou e sconfiggerlo"
			}
			{
				text = "DEVI BATTERLO prima della fine della partita o PERDERAI"
			}
	...
	generic = {
		...
		bullets = [
			...
			{
				text = "Inclina la chitarra in posizione verticale per attaccare l'altro giocatore e sconfiggerlo"
			}
			{
				text = "DEVI BATTERLO prima della fine della partita o andrai all'ELIMINATORIA"
			}
			{
				text = "Nell'ELIMINATORIA tutti i power-up sono il devastante ATTACCO MORTALE"
			}
		]
		prompt = "Pronto per un po' di rock?"
	}
...
script create_battle_helper_menu \{device_num = 0
	...
	add_user_control_helper \{text = "BATTAGLIA"
		button = green
		z = 100}
	add_user_control_helper \{text = "RIFIUTA"
		button = red
		z = 100}
endscript
