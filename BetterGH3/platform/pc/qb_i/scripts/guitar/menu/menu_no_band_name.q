...
no_band_name_messages = [
	"A meno che tu non sia L'artista precedentemente noto come Prince, immetti un nome."
	"IMMETTI UN CA@*$#&% DI NOME!!!"
	"Sei troppo figo per andare a scuola? Immetti un nome, amico."
	"Ogni volta che non inserisci il nome di un gruppo, muore un gattino."
	"Perché non immetti il nome di un gruppo? È fantastico!"
	"Se non immetti un nome, cosa potranno gridare i tuoi fan in adorazione?"
	"Ecco un suggerimento per il nome del tuo gruppo: I Senza Fantasia"
	"Vai!"
]
