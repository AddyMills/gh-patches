...
GH3_Career_Songs = {
	...
	tier1 = {
		title = "1. Un passetto alla volta"
		songs = [
			slowride
			TalkDirtyToMe
	...
	tier2 = {
		title = "2. Il tuo primo vero concerto"
		songs = [
			mississippiqueen
			schoolsout
			sunshineofyourlove
	...
	tier6 = {
		title = "6. Il gruppo più 'caldo' del mondo"
		songs = [
			blackmagicwoman
			cherubrock
			blacksunshine
	...
	tier8 = {
		title = "8. Combatti per la tua anima"
		songs = [
			rainingblood
			cliffsofdover
			numberofthebeast
