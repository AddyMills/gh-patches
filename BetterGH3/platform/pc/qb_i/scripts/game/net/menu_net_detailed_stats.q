...
script net_add_basic_stats 
	...
	if ($game_mode = p2_coop)
		...
		add_text_to_column column = <desc_column> text = "VINCE"
	endif
	add_text_to_column column = <desc_column> text = "MIGLIOR SERIE"
	add_text_to_column column = <desc_column> text = "RECORD"
endscript
