...
script create_leaving_lobby_dialog \{menu_id = leaving_lobby_dialog_menu
	...
	CreateScreenElement {
		...
		text = "Stai per abbandonare la partita corrente. Vuoi continuare?"
		just = [center top]
		internal_just = [center top]
		z_priority = (<z> + 5)
		pos = (640.0, 310.0)
	...
	if (($ui_flow_manager_state [0]) = online_pause_fs)
		...
		add_user_control_helper text = " SELEZIONA" button = green z = (<z> - 10)
		add_user_control_helper text = " INDIETRO" button = red z = (<z> - 10)
		add_user_control_helper text = "SU/GIÙ" button = strumbar z = (<z> - 10)
	endif
