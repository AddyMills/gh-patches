...
artist_text_by = "de"
artist_text_as_made_famous_by = "d'après la version de"
permanent_songlist_props = {
	avalancha = {
		checksum = avalancha
		name = 'avalancha'
	...
	bossslash = {
		checksum = bossslash
		name = 'bossslash'
		title = "Choc des guitares contre Slash"
		artist = "Slash"
		year = ", 2007"
		artist_text = $artist_text_by
		original_artist = 1
	...
	bosstom = {
		checksum = bosstom
		name = 'bosstom'
		title = "Choc des guitares contre Tom Morello"
		artist = "Tom Morello"
		year = ", 2007"
		artist_text = $artist_text_by
		original_artist = 1
	...
	bossdevil = {
		checksum = bossdevil
		name = 'bossdevil'
		title = "Choc des guitares contre Lou"
		artist = "The Charlie Daniels Band"
		year = ", 1979"
		artist_text = "inspiré par"
		original_artist = 1
		version = gh3
		leaderboard = 0
		gem_offset = 0
	...
	TalkDirtyToMe = {
		...
		artist = "Poison"
		year = ", 1986"
		artist_text = "avec Bret Michaels, d'après la version de"
		original_artist = 0
		version = gh3
		leaderboard = 1
		gem_offset = 0
