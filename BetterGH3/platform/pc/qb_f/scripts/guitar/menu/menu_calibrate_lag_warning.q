...
script create_calibrate_lag_warning_menu 
	...
	create_popup_warning_menu {
		textblock = {
			text = "Pour calibrer le décalage, tu dois recommencer cette chanson. Si tu recommences, tu perdras toute progression non sauvegardée. Es-tu sûr de vouloir continuer ?"
			dims = (800.0, 400.0)
			scale = 0.55
		}
