...
script create_detailed_stats_menu 
	...
	if ($game_mode = p2_battle)
		p1_sp_ratio = "N/D"
		p1_avg_multiplier = "N/D"
		p1_lead_percent = "N/D"
		p2_sp_ratio = "N/D"
		p2_avg_multiplier = "N/D"
		p2_lead_percent = "N/D"
	endif
	left_margin = 400
	right_margin = 800
...
script add_basic_stats_desc 
	...
	add_text_to_column column = <desc_column> text = "NOTES RÉUSSIES" dims = (400.0, 0.0)
	if NOT ($game_mode = p2_battle || $current_song = bosstom || $current_song = bossslash || $current_song = bossdevil)
		add_text_to_column column = <desc_column> text = "SÉQUENCES 1J" dims = (400.0, 0.0)
		add_text_to_column column = <desc_column> text = "MULTIPLICATEUR MOYEN" dims = (400.0, 0.0)
		if ($current_num_players = 2)
			if ($game_mode = p2_faceoff ||
					$game_mode = p2_pro_faceoff ||
					$game_mode = p2_battle)
				add_text_to_column column = <desc_column> text = "TEMPS EN TÊTE" dims = (400.0, 0.0)
			endif
		endif
	else
		add_text_to_column column = <desc_column> text = "ATTAQUES LANCÉES" dims = (400.0, 0.0)
	endif
endscript
