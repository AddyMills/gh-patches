...
script create_calibrate_lag_menu \{from_in_game = 1}
	...
	displayText \{parent = cl_container
		...
		noshadow}
	upper_helper = "Certains téléviseurs HD ont un décalage audio/vidéo qui gêne le jeu. Si tu es prêt\\nà rejeter la faute\\nsur ta télé, essaie de la calibrer."
	lower_helper = "Gratte ta guitare en suivant les notes qui traversent la cible."
	CreateScreenElement {
