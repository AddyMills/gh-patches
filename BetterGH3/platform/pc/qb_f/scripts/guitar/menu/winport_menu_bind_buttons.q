...
winport_bb_kb_menuItems = [
	{
		text = "Frette verte/confirmer"
		handler = winport_bb_choose_control
		actionNum = 0
	}
	{
		text = "Frette rouge/annuler"
		handler = winport_bb_choose_control
		actionNum = 1
	}
	{
	...
	{
		text = "Gratter haut/menu - haut"
		handler = winport_bb_choose_control
		actionNum = 10
	}
	{
		text = "Gratter bas/menu - bas"
		handler = winport_bb_choose_control
		actionNum = 9
	}
	{
	...
	{
		text = "Rétablir clavier/souris par défaut"
		handler = winport_bb_reset_to_config1
	}
	{
		text = "Rétablir le clavier par défaut"
