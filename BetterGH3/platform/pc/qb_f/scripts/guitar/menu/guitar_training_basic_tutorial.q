...
script training_basic_tutorial_show_title 
	training_show_title \{title = "Didacticiel sur les bases de Guitar Hero"}
	begin
...
script training_1_1_show_lesson_header 
	training_set_lesson_header_text \{text = "LEÇON 1 : ACCORD DE LA GUITARE"}
	training_set_lesson_header_body \{text = "1. APPUIE sur la frette correspondant à la note CHOISIE\\n2. APPUIE sur le médiator pour JOUER la note"}
	training_set_task_header_body \{text = "Joue chaque note 3 fois pour continuer"}
...
script training_1_2_start_gem_scroller 
	...
	training_set_lesson_header_text \{text = "LEÇON 2 : JOUER LES NOTES"}
	training_set_lesson_header_body \{text = "1. Lorsque les notes arrivent sur la ligne, joue-les."}
	training_show_lesson_header
	safe_show \{id = god_icon}
endscript
...
script training_1_2_show_lesson 
	...
	Wait \{6
		seconds
		ignoreslomo}
	training_set_task_header_body \{text = "Joue 8 notes pour continuer"}
	training_show_task_header
...
script training_1_3_show_lesson 
	Wait \{1
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_text \{text = "LEÇON 3 : DIFFÉRENTES NOTES"}
	training_set_lesson_header_body \{text = "1. Repère les couleurs des différentes notes pour les jouer."}
	training_show_lesson_header
	safe_show \{id = god_icon}
	training_play_sound \{Sound = 'Tutorial_1C_01_God'
		Wait}
	training_set_task_header_body \{text = "Joue des notes et réussis-en 8 pour continuer."}
	training_show_task_header
	Wait \{2
		seconds
		ignoreslomo}
...
script training_1_4_start_gem_scroller 
	...
	training_set_lesson_header_text \{text = "LEÇON 4 : NOTES LONGUES"}
...
script training_1_4_show_lesson 
	Wait \{3.55
		...
		ignoreslowmo}
	training_pause_gem_scroller
	training_set_lesson_header_body \{text = "1. Appuie sur une frette\\n2. Utilise le médiator\\n3. Continue d'appuyer sur la frette jusqu'à la fin de la note"}
	training_show_lesson_header
	...
	training_wait_for_sound \{Sound = 'Tutorial_1D_01_God'
		Wait}
	training_set_task_header_body \{text = "Joue 8 notes longues pour continuer."}
	training_show_task_header
	training_display_notes_hit \{notes_hit = 0}
	Wait \{2
		seconds
...
script training_1_5_start_gem_scroller 
	...
	training_set_lesson_header_text \{text = "LEÇON 5 : ACCORDS"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
...
script training_1_5_show_lesson 
	Wait \{3.5
		...
		ignoreslomo}
	training_pause_gem_scroller
	training_set_lesson_header_body \{text = "Deux notes jouées simultanément"}
	training_show_lesson_header
	...
	training_set_task_header_body \{text = "Joue 8 accords pour continuer"}
	training_show_task_header
	training_display_notes_hit \{notes_hit = 0}
	Wait \{2
		seconds
...
script training_1_6_show_hud 
	training_set_lesson_header_text \{text = "LEÇON 6 : INTERFACE"}
	training_set_lesson_header_body \{text = ""}
	training_show_lesson_header
	safe_show \{id = god_icon}
	...
	Wait \{8.0
		seconds
		ignoreslomo}
	training_set_lesson_header_body \{text = "Jaune = moyen"}
	Wait \{5.5
		seconds
		ignoreslomo}
...
script training_1_6_complete 
	...
	CreateScreenElement {
		...
		pos = (640.0, 350.0)
		font = ($training_font)
		text = "Didacticiel sur les bases terminé !"
		scale = 1.0
		rgba = ($training_text_color)
	}
