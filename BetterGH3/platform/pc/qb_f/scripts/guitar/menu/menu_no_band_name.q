...
no_band_name_messages = [
	"À moins que tu ne sois celui qu'on appelait Prince, entre un nom."
	"ENTRE UN P@*$#&% DE NOM !!!"
	"L'école, c'est pour les ringards ou quoi ? Entre un nom, mec."
	"À chaque fois que tu n'entres pas un nom de groupe, un chaton meurt."
	"Vas-y, entre un nom de groupe. Tu verras, on se sent tellement bien après."
	"Et quel nom ton public va-t-il bien pouvoir hurler si tu n'en as pas ?"
	"Tiens voilà une suggestion : Jean-Cancre de la Flémardise"
	"Dépêche-toi !"
]
