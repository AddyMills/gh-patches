...
script setup_sprites 
	...
	CreateScreenElement \{type = TextElement
		...
		text = "D'APRÈS L'INTERPRÉTATION DE"
		z_priority = 5.0
		alpha = 0
		shadow
		shadow_offs = (1.0, 1.0)}
