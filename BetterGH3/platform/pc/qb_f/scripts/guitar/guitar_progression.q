...
GH3_Career_Songs = {
	...
	tier1 = {
		title = "1. Commence à partir de rien"
		songs = [
			slowride
			TalkDirtyToMe
	...
	tier4 = {
		title = "4. À la conquête de l'Europe"
		songs = [
			paranoid
			anarchyintheuk
			koolthing
