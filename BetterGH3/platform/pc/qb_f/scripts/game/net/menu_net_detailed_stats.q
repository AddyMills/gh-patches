...
script net_add_basic_stats 
	...
	if ($game_mode = p2_coop)
		...
		add_text_to_column column = <desc_column> text = "GAGNE"
	endif
	add_text_to_column column = <desc_column> text = "MEILLEURE SÉRIE"
	add_text_to_column column = <desc_column> text = "MEILLEURS SCORES"
endscript
