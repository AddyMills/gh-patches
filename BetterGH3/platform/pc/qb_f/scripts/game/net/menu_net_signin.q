	...
	if NOT (NetSessionFunc func = IsConnected)
		...
		switch (<CurrentNetworkTask>)
			...
			switch (<CurrentNetworkStatus>)
				...
				case "DONE"
				statusText = "Services en ligne préts"
				case "FAILED"
				statusText = "Impossible d'initialiser les services en ligne"
				success = false
				default
				statusText = "Erreur interne : état de réseau inattendu !"
				success = false
			endswitch
			case "CHECK_DNS"
			switch (<CurrentNetworkStatus>)
				case "PENDING"
				statusText = "Localisation des serveurs de jeu"
				case "DONE"
				statusText = "Serveurs de jeux localisés"
				success = true
				case "FAILED"
				statusText = "Impossible de localiser les serveurs de jeu"
				success = false
				default
				statusText = "Erreur interne : état de réseau inattendu !"
				success = false
...
script create_winport_account_management_status_screen 
	...
	switch (<CurrentNetworkTask>)
		...
		switch (<CurrentNetworkStatus>)
			...
			case "DONE"
			statusText = "Compte créé"
			success = true
			case "FAILED"
			statusText = "Création de compte impossible"
			success = false
			default
			statusText = "Erreur interne : état de réseau inattendu !"
			success = false
		...
		switch (<CurrentNetworkStatus>)
			...
			case "DONE"
			statusText = "Mot de passe modifié"
			success = true
			case "FAILED"
			statusText = "Changement de mot de passe impossible"
			success = false
			default
			statusText = "Erreur interne : état de réseau inattendu !"
			success = false
		...
		switch (<CurrentNetworkStatus>)
			...
			case "DONE"
			statusText = "Mot de passe de compte réinitialisé"
			success = true
			case "FAILED"
			statusText = "Impossible de réinitialiser le compte"
			success = false
			default
			statusText = "Erreur interne : état de réseau inattendu !"
			success = false
	...
	if (<success> = false)
		...
		switch <FailureCode>
			...
			case 667
			statusText = "Échec du service d'autorisation"
			case 668
			...
			case 700
			statusText = "Tâche effectuée"
			case 701
			statusText = "Demande d'autorisation incorrecte"
			case 702
			statusText = "Erreur de configuration du serveur"
			case 703
			statusText = "Identifiant de titre de jeu incorrect"
			case 704
			statusText = "Informations de compte incorrectes"
			case 705
			statusText = "Demande d'autorisation illégale"
			case 706
			statusText = "Code de licence incorrect"
			case 707
			statusText = "Nom d'utilisateur déjà existant"
			case 708
			statusText = "Format de nom d'utilisateur incorrect"
			case 709
			statusText = "Nom d'utilisateur rejeté"
			case 710
			statusText = "Trop de comptes pour le code de licence"
			case 711
			statusText = "Migration de compte pas prise en charge"
			case 712
			statusText = "Le titre a été désactivé"
			case 713
			statusText = "Le compte a expiré"
			case 714
			statusText = "Le compte est verrouillé"
			case 715
			statusText = "Erreur d'authentification. Les fonctions en ligne ne seront pas disponibles avant d'avoir quitté Guitar Hero III et relancé le jeu."
			case 716
